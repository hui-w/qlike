/* world-path | https://github.com/hui-w/world-path */
var Config={version:"1.25.B8",keyboard:{changeUnit:40,timerDelay:50},Toolbar:{navUnit:20,navTimerDelay:100,zoomTimerDelay:150,marginTop:16,marginLeft:8,marginRight:8,marginBottom:16,buttonSpacing:8,buttonPadding:8,buttonSize:48},WorldMap:{maxScale:30,minScale:.5,moveTimerDelay:30,moveDuration:400,zoomTimerDelay:30,ghostCountries:[{country:"US",offset:1},{country:"CA",offset:1},{country:"CN",offset:-1},{country:"TW",offset:-1},{country:"KR",offset:-1},{country:"JP",offset:-1}],defaultProfile:["h"]},
colors:"#37C719 #E66C0F #D5312C #1B2258 #E62760 #3051EA".split(" "),colorIndex:0};(function(a){if("replaceState"in history)a.replaceHash=function(c){"#"!==(""+c).charAt(0)&&(c="#"+c);history.replaceState("","",c)};else{var b=location.hash;a.replaceHash=function(c){location.hash!==b&&history.back();location.hash=c}}})(window);
var Util={$:function(){for(var a=[],b=0;b<arguments.length;b++){var c=arguments[b];"string"==typeof c&&(c=document.getElementById(c));if(1==arguments.length)return c;a.push(c)}return a},getQueryStringByName:function(a,b){null==b&&(b=location.search);a=b.match(new RegExp("[?&]"+a+"=([^&]+)","i"));return null==a||1>a.length?null:decodeURIComponent(a[1])},setQueryString:function(a,b){var c=new URL(window.location.href);""===b||null===b||void 0===b?c.searchParams.delete(a):c.searchParams.set(a,b);history.replaceState(void 0,
void 0,c.toString())},setUrlHash:function(a,b){var c=window.location.hash;if(0>=c.length)window.location.hash=a+"="+b;else{var d=a+"=([^&]*)",e=c.match(new RegExp(d,"i")),f=c;null==e||1>e.length?""!==b&&(f=c+"&"+a+"="+b):""===b?(f=c.replace(new RegExp("&?"+a+"=([^&]*)&?","i"),function(g,l,m,p){if(0===g.indexOf("&")&&"&"===g.charAt(g.length-1))return"&";0!==g.indexOf("&")&&g.charAt(g.length-1);return""}),f=f.replace(/&&+/g,"&"),f=f.replace(/#&/,"#")):f=c.replace(new RegExp(d,"i"),a+"="+b);history.replaceState(void 0,
void 0,f)}},getUrlHash:function(a,b){null==b&&(b=window.location.hash);a=b.match(new RegExp("[#&]"+a+"=([^&]+)","i"));return null==a||1>a.length?null:a[1]},isNull:function(a){return"undefined"==a||null==a},is:function(a,b){b=String.prototype.toLowerCase.call(b);return"finite"==b?isFinite(a):"array"==b&&(a instanceof Array||Array.isArray&&Array.isArray(a))?!0:"null"==b&&null===a||b==typeof a&&null!==a||"object"==b&&a===Object(a)||Object.prototype.toString.call(a).slice(8,-1).toLowerCase()==b},format_str:function(){var a=
/\{([^\}]+)\}/g,b=/(?:(?:^|\.)(.+?)(?=\[|\.|$|\()|\[('|")(.+?)\2\])(\(\))?/g,c=function(d,e,f){var g=f;e.replace(b,function(l,m,p,q,r){m=m||q;g&&(m in g&&(g=g[m]),"function"==typeof g&&r&&(g=g()))});return g=(null==g||g==f?d:g)+""};return function(d,e){return String(d).replace(a,function(f,g){return c(f,g,e)})}}()},Browser={versions:function(){var a=navigator.userAgent;return{trident:-1<a.indexOf("Trident"),presto:-1<a.indexOf("Presto"),webKit:-1<a.indexOf("AppleWebKit"),gecko:-1<a.indexOf("Gecko")&&
-1==a.indexOf("KHTML"),mobile:!!a.match(/AppleWebKit.*Mobile.*/),ios:!!a.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/),android:-1<a.indexOf("Android")||-1<a.indexOf("Linux"),iPhone:-1<a.indexOf("iPhone"),iPad:-1<a.indexOf("iPad"),webApp:-1==a.indexOf("Safari")}}(),language:(navigator.browserLanguage||navigator.language).toLowerCase()};
...
function Frame(a,b,c,d){this.map=a;this.map.frame=this;this.width=b;this.height=c;this.toolbar=null;if(this.fullscreen=d)this.width=document.documentElement.clientWidth,this.height=document.documentElement.clientHeight;this.statusLabel=this.frameObj=null;this.isHolding=!1;this.mousePoint={x:-1,y:-1};this.mapStartPosition=this.touchStartPoint=this.touchState=null;this.hasMoved=!1;this.startScale=this.startDistance=this.zoomCenter=null;this.arrowKeyStatus=0;this.keyboardTimer=null;this.inMotion=!1;
this.currentAnimation=null}
Frame.prototype={startAnimation:function(a,b,c,d){var e=this;this.stopAnimation();c<Config.WorldMap.minScale?c=Config.WorldMap.minScale:c>Config.WorldMap.maxScale&&(c=Config.WorldMap.maxScale);var f=this.width/2-a*c,g=this.height/2-b*c,l=Date.now(),m=this.map.left,p=this.map.top,q=this.map.scale,r=function(){var n=Date.now()-l;n=Math.min(n/1200,1);var k=1-Math.pow(1-n,3),t=p+(g-p)*k,u=q+(c-q)*k;e.map.left=m+(f-m)*k;e.map.top=t;e.map.scale=u;e.map.updateTransform();if(1<=n){e.map.left=f;e.map.top=
g;e.map.scale=c;e.map.updateTransform();if("function"==typeof e.map.onPositionChanged)e.map.onPositionChanged();if("function"==typeof e.map.onScaleChanged)e.map.onScaleChanged();e.currentAnimation=null;e.inMotion=!1;"function"==typeof d&&d()}else e.currentAnimation=requestAnimationFrame(r)};this.inMotion=!0;this.currentAnimation=requestAnimationFrame(r)},stopAnimation:function(){this.currentAnimation&&(cancelAnimationFrame(this.currentAnimation),this.currentAnimation=null,this.inMotion=!1)},setCenterAndScale:function(a,
b,c,d){this.startAnimation(a,b,c,d)},setCenterPoint:function(a,b,c,d){c?this.startAnimation(a,b,this.map.scale,d):(this.map.moveTo(this.width/2-a*this.map.scale,this.height/2-b*this.map.scale),"function"==typeof d&&d())},scaleMapTo:function(a,b){var c=this.getCenterPoint();this.startAnimation(c.cx,c.cy,a,b)},moveMapTo:function(a,b,c){this.startAnimation((this.width/2-a)/this.map.scale,(this.height/2-b)/this.map.scale,this.map.scale,c)},getCenterPoint:function(){return{cx:(this.width/2-this.map.left)/
this.map.scale,cy:(this.height/2-this.map.top)/this.map.scale}},renderInto:function(a,b){var c=this;this.frameObj=document.createElement("div");var d=Util.format_str("width: {width}px; height: {height}px; cursor: default; overflow: hidden; border: none; background-color: RGBA(100, 100, 100, 0.2);",{width:this.width,height:this.height});this.frameObj.setAttribute("style",d);a.appendChild(this.frameObj);this.toolbar=new Toolbar(this);this.map.renderInto(this.frameObj,function(){c.enableInteractive();
c.toolbar.renderInto(c.map.getExtraGroup());c.statusLabel=c.map.getExtraGroup().createChildNS("text",{fill:"#666",class:"no-select",x:4,y:10,"font-size":8});var f=Util.getUrlHash("cx"),g=Util.getUrlHash("cy"),l=Util.getUrlHash("s");null!=f&&null!=g?(f=parseFloat(f),g=parseFloat(g),l=null!=l?parseFloat(l):c.map.scale,c.map.scale=l,c.map.moveTo(c.width/2-f*l,c.height/2-g*l),c.map.updateTransform()):c.setCenterPoint(c.map.width/2,c.map.height/2,!1,null);c.updateStatusLabel();l=Util.getUrlHash("r");f=
Util.getUrlHash("f");0==l&&c.toolbar.showRoutes(!1);0==f&&c.toolbar.showFlights(!1);"function"==typeof b&&b()});this.toolbar.onZoom=function(f){var g=c.convertFramePointToMap(c.width/2,c.height/2);return c.map.zoom(f,g)};this.toolbar.onZoomRestore=function(){c.scaleMapTo(1,null)};this.toolbar.onNavigate=function(f,g){c.map.move(f,g)};this.toolbar.onNaviRestore=function(){c.setCenterPoint(c.map.width/2,c.map.height/2,!0,null)};this.map.onScaleChanged=function(){c.updateStatusLabel()};this.map.onPositionChanged=
function(){c.updateStatusLabel()};if(this.fullscreen){var e=function(){c.map.resize(c.width,c.height);c.toolbar.adjustPosition(c.width,c.height)};setInterval(function(f){f=document.documentElement.clientWidth;var g=document.documentElement.clientHeight;if(f!=c.width||g!=c.height)c.width=f,c.height=g,c.frameObj.style.width=c.width+"px",c.frameObj.style.height=c.height+"px",e()},200);e()}else this.toolbar.adjustPosition(this.width,this.height)},updateStatusLabel:function(){this.statusLabel.textContent=
"[{0}, {1}] x {2}".format(this.map.left.toFixed(1),this.map.top.toFixed(1),this.map.scale.toFixed(1));var a=this.getCenterPoint();Util.setUrlHash("cx",a.cx.toFixed(3));Util.setUrlHash("cy",a.cy.toFixed(3));Util.setUrlHash("s",this.map.scale.toFixed(3))},enableInteractive:function(){var a=this;this.handleTouchEvent=function(c){if(!c._handled)switch(c.preventDefault(),c.type){case "touchstart":a._onTouchStart(c);break;case "touchmove":a._onTouchMove(c);break;case "touchend":a._onTouchEnd(c);break;case "touchcancel":a._onTouchCancel(c)}};
var b={passive:!1};this.frameObj.addEventListener("touchstart",this.handleTouchEvent,b);this.frameObj.addEventListener("touchmove",this.handleTouchEvent,b);this.frameObj.addEventListener("touchend",this.handleTouchEvent,b);this.frameObj.addEventListener("touchcancel",this.handleTouchEvent,b);this.handleMouseEvent=function(c){if(!a.inMotion)switch(c.preventDefault(),c.type){case "mousedown":a.eventDown(c);break;case "mousemove":a.eventMove(c);break;case "mouseup":a.eventUp(c);break;case "mouseleave":a.isHolding=
!1;a.inMotion=!1;a._stopDragging();break;case "mousewheel":var d=a.getEventPositionOnMap(c);d&&a.map.zoom(0<c.wheelDelta?1.1:.9,d)}};this.frameObj.addEventListener("mousedown",this.handleMouseEvent,!1);this.frameObj.addEventListener("mousemove",this.handleMouseEvent,!1);this.frameObj.addEventListener("mouseup",this.handleMouseEvent,!1);this.frameObj.addEventListener("mouseleave",this.handleMouseEvent,!1);this.frameObj.addEventListener("dblclick",this.handleMouseEvent,!1);this.frameObj.addEventListener("mousewheel",
this.handleMouseEvent,!1);this.handleKeyEvent=function(c){a.inMotion||a.handleKey(c,a)};document.addEventListener("keydown",this.handleKeyEvent,!1);document.addEventListener("keyup",this.handleKeyEvent,!1)},eventDown:function(a){!a._handled&&(this.isHolding=!0,a.type&&0===a.type.indexOf("mouse")&&this._startDragging(),a=this.getEventCoordinates(a))&&(this.mousePoint.x=a.x,this.mousePoint.y=a.y)},eventUp:function(a){this.isHolding=!1;this._stopDragging()},eventMove:function(a){!a._handled&&this.isHolding&&
(a.type&&0===a.type.indexOf("touch")&&this._startDragging(),a=this.getEventCoordinates(a))&&(this.map.move(a.x-this.mousePoint.x,a.y-this.mousePoint.y),this.mousePoint.x=a.x,this.mousePoint.y=a.y)},_onTouchStart:function(a){this.stopAnimation();a=a.touches;1===a.length?this._startSingleTouch(a[0]):2===a.length&&this._startPinchZoom(a[0],a[1])},_onTouchMove:function(a){a=a.touches;1===a.length&&"pan"===this.touchState?this._continueSingleTouch(a[0]):2===a.length&&"zoom"===this.touchState&&this._continuePinchZoom(a[0],
a[1])},_onTouchEnd:function(a){a=a.touches;0===a.length?this._endTouch():1===a.length&&"zoom"===this.touchState&&(this.touchState="pan",this.startScale=this.startDistance=null,this._startSingleTouch(a[0]))},_onTouchCancel:function(a){this._endTouch()},_startSingleTouch:function(a){this.touchState="pan";this.isHolding=!0;if(a=this.getEventCoordinates(a))this.touchStartPoint={x:a.x,y:a.y},this.mapStartPosition={x:this.map.left,y:this.map.top},this.hasMoved=!1},_continueSingleTouch:function(a){if(this.isHolding&&
this.touchStartPoint&&this.mapStartPosition){var b=this.getEventCoordinates(a);if(b){a=b.x-this.touchStartPoint.x;b=b.y-this.touchStartPoint.y;if(!this.hasMoved)if(5<Math.abs(a)+Math.abs(b))this.hasMoved=!0,this._startDragging();else return;this.map.moveTo(this.mapStartPosition.x+a,this.mapStartPosition.y+b)}}},_startPinchZoom:function(a,b){this.touchState="zoom";this.isHolding=!1;this._stopDragging();a=this.getEventCoordinates(a);b=this.getEventCoordinates(b);a&&b&&(this.startDistance=this.getDistance(a.x,
a.y,b.x,b.y),this.startScale=this.map.scale,this.zoomCenter={x:(a.x+b.x)/2,y:(a.y+b.y)/2})},_continuePinchZoom:function(a,b){this.startDistance&&this.startScale&&this.zoomCenter&&(a=this.getEventCoordinates(a),b=this.getEventCoordinates(b),a&&b&&(b=this.getDistance(a.x,a.y,b.x,b.y),b=b/this.startDistance*this.startScale,b=Math.max(Config.WorldMap.minScale,Math.min(Config.WorldMap.maxScale,b)),this.map.zoomTo(b,{x:this.zoomCenter.x-this.map.left,y:this.zoomCenter.y-this.map.top})))},_endTouch:function(){this.touchState=
null;this.isHolding=!1;this.mapStartPosition=this.touchStartPoint=this.zoomCenter=this.startScale=this.startDistance=null;this.hasMoved=!1;this._stopDragging()},emergencyReset:function(){console.warn("Emergency reset triggered");this.stopAnimation();this.isHolding=this.inMotion=!1;this.startDistance=null;this.arrowKeyStatus=0;this._stopDragging();this.mapStartPosition=this.touchStartPoint=this.touchState=null;this.hasMoved=!1;this.startScale=this.startDistance=this.zoomCenter=null;this.keyboardTimer&&
(clearTimeout(this.keyboardTimer),this.keyboardTimer=null);this.mousePoint.x=-1;this.mousePoint.y=-1},handleKey:function(a){var b=this,c=a.keyCode;switch(a.type){case "keydown":var d=function(){var e=Config.keyboard.changeUnit,f=0,g=0;0<(b.arrowKeyStatus&1)&&(f+=e);0<(b.arrowKeyStatus&2)&&(g+=e);0<(b.arrowKeyStatus&4)&&(f-=e);0<(b.arrowKeyStatus&8)&&(g-=e);0<b.arrowKeyStatus?(b.map.move(f,g),b.keyboardTimer=setTimeout(d,Config.keyboard.timerDelay)):b.keyboardTimer=null};switch(c){case 37:case 65:this.arrowKeyStatus|=
1;break;case 38:case 87:this.arrowKeyStatus|=2;break;case 39:case 68:this.arrowKeyStatus|=4;break;case 40:case 83:this.arrowKeyStatus|=8}0<this.arrowKeyStatus&&null==this.keyboardTimer&&d();break;case "keyup":switch(c){case 37:case 65:b.arrowKeyStatus&=-2;break;case 38:case 87:b.arrowKeyStatus&=-3;break;case 39:case 68:b.arrowKeyStatus&=-5;break;case 40:case 83:b.arrowKeyStatus&=-9}0==b.arrowKeyStatus&&null!=b.keyboardTimer&&(clearTimeout(b.keyboardTimer),b.keyboardTimer=null)}},getEventCoordinates:function(a){var b=
a.clientX;a=a.clientY;if(void 0===b||void 0===a)return null;var c=this.frameObj.getBoundingClientRect();return{x:b-c.left,y:a-c.top}},getEventPositionOnMap:function(a){return(a=this.getEventCoordinates(a))?{x:a.x-this.map.left,y:a.y-this.map.top}:null},getDistance:function(a,b,c,d){return Math.sqrt((c-a)*(c-a)+(d-b)*(d-b))},_startDragging:function(){document.body.classList.add("dragging")},_stopDragging:function(){document.body.classList.remove("dragging")},convertFramePointToMap:function(a,b){return{x:a-
this.frameObj.offsetLeft-this.map.left,y:b-this.frameObj.offsetTop-this.map.top}},addCustomButton:function(a,b,c,d){this.toolbar&&this.toolbar.renderCustomButton(a,b,c,d)}};function WorldMap(){this.parent=this.frame=null;this.width=1E3;this.height=400;this.scale=1;this.top=this.left=0;this.onPositionChanged=this.onScaleChanged=this.extraGroup=this.mapGroup=this.svg=null}WorldMap.GHOST_POIS=null;
WorldMap.prototype={_calculateGhostPois:function(){if(null===WorldMap.GHOST_POIS){for(var a=[],b=[],c=Config.WorldMap.ghostCountries||[],d={},e=0;e<c.length;e++)d[c[e].country]=c[e].offset;c={};if(window.mapdata&&window.mapdata.pois)for(e=0;e<window.mapdata.pois.length;e++){var f=window.mapdata.pois[e];c[f.key]=f.country}e={};if(window.mapdata&&window.mapdata.flights)for(f=0;f<window.mapdata.flights.length;f++)for(var g=window.mapdata.flights[f],l=0;l<g.length;l++){var m=g[l];if(m.crossPacific){var p=
c[m.from];p&&d[p]&&(e[m.from]=d[p]);(p=c[m.to])&&d[p]&&(e[m.to]=d[p])}}for(var q in e)e.hasOwnProperty(q)&&(d=e[q],0<d?a.push(q):0>d&&b.push(q));WorldMap.GHOST_POIS={POSITIVE_X:a,NEGATIVE_X:b}}},renderInto:function(a,b){this.parent=a;this.svg=this.parent.createChildNS("svg",{id:"svg",width:this.width,height:this.height});this.mapGroup=this.svg.createChildNS("g");this.extraGroup=this.svg.createChildNS("g");this._calculateGhostPois();this.renderCountries(this.mapGroup);"function"==typeof b&&b()},resize:function(a,
b){this.svg.style.width=a+"px";this.svg.style.height=b+"px";this.svg.attr("width",a);this.svg.attr("height",b)},getExtraGroup:function(){return this.extraGroup},_clearElementCache:function(){this._poiElements=this._routePaths=this._flightPaths=this._cachedElements=null},updateTransform:function(){this.mapGroup.attr({transform:Util.format_str("translate({left}, {top}) scale({scale}, {scale})",{left:this.left,top:this.top,scale:this.scale})});this._cachedElements||(this._cachedElements={countries:this.mapGroup.querySelectorAll("path.country"),
border:this.mapGroup.querySelector("path.border"),routes:this.mapGroup.querySelectorAll("path.route, path.flight")});for(var a=1/this.scale,b=this._cachedElements.countries,c=0;c<b.length;c++)b[c].attr("stroke-width",a);if(c=this._cachedElements.border)c.attr("stroke-width",a),c.attr("stroke-dasharray",Util.format_str("{size},{size}",{size:5/this.scale}));c=this._shouldHidePoisForYearFilter();this._updatePoiLabels(c);this._updatePoiCircles(c);b=this.mapGroup.querySelectorAll("path.route, path.flight");
var d="{0},{0}".format(2/this.scale);for(c=0;c<b.length;c++)b[c].attr("stroke-width",a),null!=b[c].attr("stroke-dasharray")&&b[c].attr("stroke-dasharray",d);this._cachedElements&&(this._cachedElements.routes=b)},renderCountries:function(a){for(var b in worldmap.shapes)a.createChildNS("path",{d:worldmap.shapes[b],stroke:"#333333",fill:"#f0efeb","stroke-opacity":.6,"stroke-width":1,class:"country"});b=Config.WorldMap.ghostCountries||[];for(var c=0;c<b.length;c++){var d=b[c];this.renderGhostCountry(this.mapGroup,
d.country,0<d.offset?this.width:-this.width)}a.createChildNS("path",{d:Util.format_str("M0,0 H{width} V{height} H0 Z",{width:this.width,height:this.height}),stroke:"#000000",fill:"none","stroke-width":1,"stroke-opacity":.2,"stroke-dasharray":"5,5",class:"border"})},getCountryCenter:function(a){if(!worldmap.shapes||!worldmap.shapes[a])return null;var b=this.mapGroup.querySelectorAll("path.country");a=worldmap.shapes[a];for(var c=0;c<b.length;c++){var d=b[c],e=d.attr("d"),f=d.attr("transform");if(e===
a&&(!f||""===f))try{var g=d.getBBox();return{x:g.x+g.width/2,y:g.y+g.height/2}}catch(l){break}}return null},renderGhostCountry:function(a,b,c){var d=this;a=a.createChildNS("path",{d:worldmap.shapes[b],stroke:"RGBA(127,127,127, 0.4)",fill:"RGBA(255,255,255,0.2)","stroke-opacity":.6,"stroke-width":1,class:"country",style:"cursor: pointer;",transform:Util.format_str("translate({left},0)",{left:c})});a.addEventListener("mouseover",function(){this.attr("fill","RGBA(255,255,255,1)")},!1);a.addEventListener("mouseout",
function(){this.attr("fill","RGBA(255,255,255,0.2)")},!1);var e=function(){var f=d.getCountryCenter(b);f&&d.frame?d.frame.setCenterPoint(f.x,f.y,!0,null):d.frame.moveMapTo(d.left+c*d.scale,d.top,null)};a.addEventListener("mousedown",function(){e()},!1);a.addEventListener("touchstart",function(){e()},!1)},renderPois:function(a){var b=this;window.mapdata.pois.forEach(function(c){b.renderPoi(a,c,0);b._renderGhostPois(a,c)})},renderPoi:function(a,b,c){var d=b.label,e=b.level,f=b.key,g=this.parseLatLon(b.latlon);
b=g.x;g=g.y;null!=c&&0!=c&&(b+=c);a.createChildNS("circle",{cx:b,cy:g,r:0,fill:"#E66C0F",stroke:"none",class:"poi-circle","data-poi-key":f});a.createChildNS("text",{x:b,y:g,fill:"#000000",stroke:"none","font-size":1/this.scale*12,class:"poi-label",style:"display: none","data-level":e,"data-poi-key":f},d)},getControlPoint:function(a,b,c,d){var e=(a.x+b.x)/2;b=(a.y+b.y)/2;var f=Math.sqrt(Math.pow(a.x-e,2)+Math.pow(a.y-b,2));c*=f;var g={x:(a.y-b)*c/f+e,y:(e-a.x)*c/f+b};a={x:(b-a.y)*c/f+e,y:(a.x-e)*c/
f+b};return 0<Math.atan2(g.y-b,g.x-e)*d?g:a},drawFlightLine:function(a,b,c,d){0==d?(this.drawFlightLine(a,b,c,-1),this.drawFlightLine(a,b,c,1)):(d=this.getControlPoint(b,c,.6,d),a.createChildNS("path",{d:Util.format_str("M{from.x},{from.y} Q{control.x},{control.y} {to.x},{to.y}",{from:{x:b.x,y:b.y},control:{x:d.x,y:d.y},to:{x:c.x,y:c.y}}),fill:"none",stroke:Config.colors[Config.colorIndex%Config.colors.length],"stroke-width":1,class:"flight"}))},renderFlight:function(a,b,c,d,e){b=this.getPoiPosition(b);
c=this.getPoiPosition(c);d?(d={x:b.x>c.x?b.x-this.width:this.width+b.x,y:b.y},this.drawFlightLine(a,b,{x:b.x>c.x?this.width+c.x:c.x-this.width,y:c.y},e),this.drawFlightLine(a,d,c,e)):this.drawFlightLine(a,b,c,e)},renderRouteGroup:function(a,b){var c=this,d="";b.forEach(function(e){e=0<e.indexOf(",")?c.parseLatLon(e):c.getPoiPosition(e);d=0<d.length?d+" L{0},{1}".format(e.x,e.y):d+"M{0},{1}".format(e.x,e.y)});a.createChildNS("path",{d:d,fill:"none",stroke:"#ff0000","stroke-width":1,"stroke-dasharray":"2,2",
class:"route"})},renderFlightsAndRoutes:function(a){var b=this;window.mapdata.flights.forEach(function(c){c.forEach(function(d){b.renderFlight(a,d.from,d.to,d.crossPacific,d.direction)});Config.colorIndex++});window.mapdata.routes.forEach(function(c){b.renderRouteGroup(a,c.path)})},zoom:function(a,b){if(this.scale<Config.WorldMap.minScale&&1>a||this.scale>Config.WorldMap.maxScale&&1<a)return!1;var c=b.x*(1-a);b=b.y*(1-a);this.scale*=a;this.move(c,b)||this.updateTransform();if("function"==typeof this.onScaleChanged)this.onScaleChanged();
return!0},zoomTo:function(a,b){return this.zoom(a/this.scale,b)},move:function(a,b){if(0==a&&0==b)return!1;this.moveTo(this.left+a,this.top+b,null);return!0},moveTo:function(a,b){this.left=a;this.top=b;this.updateTransform();if("function"==typeof this.onPositionChanged)this.onPositionChanged()},showFlights:function(a){this._flightPaths||(this._flightPaths=this.mapGroup.querySelectorAll("path.flight"));var b=this._flightPaths;requestAnimationFrame(function(){for(var c=0;c<b.length;c++)b[c].updateStyle("display",
a?null:"none")})},filterByYears:function(a){this.filterByYearsAndProfiles(a,Config.WorldMap.defaultProfile)},filterByYearsAndProfiles:function(a,b){if(a&&0!==a.length){b&&0!==b.length||(b=Config.WorldMap.defaultProfile.slice());this._clearAllElements();this._clearElementCache();var c=this._filterFlightsByYearsAndProfiles(a,b);this._renderFilteredFlights(c);this._renderFilteredRoutes(a,b);this._renderFilteredPoisWithProfiles(a,b);this.updateTransform()}else this._clearAllElements(),this._clearElementCache(),
this._flightPaths=null},_filterFlightsByYears:function(a){return this._filterFlightsByYearsAndProfiles(a,Config.WorldMap.defaultProfile)},_filterFlightsByYearsAndProfiles:function(a,b){var c=[],d=this;window.mapdata.flights.forEach(function(e){var f=[];e.forEach(function(g){var l=g.year&&-1!==a.indexOf(g.year),m=d._matchesProfile(g.profile,b);l&&m&&f.push(g)});0<f.length&&c.push(f)});return c},_renderFilteredPois:function(a){this._renderFilteredPoisWithProfiles(a,Config.WorldMap.defaultProfile)},
_renderFilteredPoisWithProfiles:function(a,b){var c=this;window.mapdata.pois.forEach(function(d){var e=c._shouldShowPoiForYears(d,a),f=c._matchesProfile(d.profile,b);e&&f&&(c.renderPoi(c.mapGroup,d,0),c._renderGhostPois(c.mapGroup,d))})},_shouldShowPoiForYears:function(a,b){if(!a.year)return!1;a=this._parseYears(a.year);for(var c=0;c<a.length;c++)if(-1!==b.indexOf(a[c]))return!0;return!1},_parseYears:function(a){return"string"===typeof a?-1<a.indexOf(",")?a.split(",").map(function(b){return parseInt(b.trim())}):
[parseInt(a)]:[a]},showRoutes:function(a){this._routePaths||(this._routePaths=this.mapGroup.querySelectorAll("path.route"));var b=this._routePaths;requestAnimationFrame(function(){for(var c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")})},showPois:function(a){this._poiElements||(this._poiElements=this.mapGroup.querySelectorAll("circle.poi-circle, text.poi-label"));var b=this._poiElements;requestAnimationFrame(function(){for(var c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")})},
restoreOriginalRendering:function(){this._clearAllElements();Config.colorIndex=0;this.renderFlightsAndRoutes(this.mapGroup);this.renderPois(this.mapGroup);this._applyCurrentToggleStates();this.updateTransform()},getPoi:function(a){for(var b=0;b<window.mapdata.pois.length;b++)if(window.mapdata.pois[b].key==a)return window.mapdata.pois[b];return null},getPoiPosition:function(a){a=this.getPoi(a);return null!=a?this.parseLatLon(a.latlon):{x:0,y:0}},getXY:function(a,b){return{x:2.6938*b+465.4,y:-2.6938*
a+227.066}},getLatLon:function(a,b){return{lat:(b-227.066)/-2.6938,lon:(a-465.4)/2.6938}},parseLatLon:function(a){var b=(a=String(a).split(/(\d+(?:\.\d+)?)[\xb0\s]?\s*(?:(\d+(?:\.\d+)?)['\u2019\u2032\s])?\s*(?:(\d+(?:\.\d+)?)["\u201d\u2033\s])?\s*([SNEW])?/i))&&+a[1]+(a[2]||0)/60+(a[3]||0)/3600;"S"==a[4].toUpperCase()&&(b=-b);var c=a&&+a[6]+(a[7]||0)/60+(a[8]||0)/3600;"W"==a[9].toUpperCase()&&(c=-c);return this.getXY(b,c)},getScreenCenterPointOnMap:function(){return{x:(this.frame.width/2-this.left)/
this.scale,y:(this.frame.height/2-this.top)/this.scale}},_clearElements:function(a){a=this.mapGroup.querySelectorAll(a);for(var b=0;b<a.length;b++)a[b].parentNode.removeChild(a[b])},_clearAllElements:function(){this._clearElements("path.flight");this._clearElements("path.route");this._clearElements("circle.poi-circle, text.poi-label")},_renderGhostPois:function(a,b){null===WorldMap.GHOST_POIS&&this._calculateGhostPois();WorldMap.GHOST_POIS&&-1!==WorldMap.GHOST_POIS.POSITIVE_X.indexOf(b.key)&&this.renderPoi(a,
b,this.width);WorldMap.GHOST_POIS&&-1!==WorldMap.GHOST_POIS.NEGATIVE_X.indexOf(b.key)&&this.renderPoi(a,b,-this.width)},_shouldHidePoisForYearFilter:function(){return this.frame&&this.frame.toolbar&&this.frame.toolbar.selectedYears&&0===this.frame.toolbar.selectedYears.length},_isToggleEnabled:function(a){if(!this.frame||!this.frame.toolbar)return!0;a="flight"===a?this.frame.toolbar.flightOverlay:this.frame.toolbar.routesOverlay;return!a||"none"!==a.attr("stroke")},_updatePoiCircles:function(a){for(var b=
this.mapGroup.querySelectorAll("circle.poi-circle"),c=this.mapGroup.querySelectorAll("text.poi-label"),d={},e=0;e<c.length;e++){var f=c[e],g=f.attr("data-poi-key");f=f.attr("data-level");f=Util.isNull(f)?0:parseFloat(f);d[g]=!a&&this.scale>=f}for(a=0;a<b.length;a++)c=b[a],g=c.attr("data-poi-key"),d[g]?(g=1/this.scale*4,1>this.scale&&(g/=2),c.attr("r",g),c.attr("fill","#E66C0F")):(g=1/this.scale*1.5,1>this.scale&&(g/=2),c.attr("r",g),c.attr("fill","#999999"))},_updatePoiLabels:function(a){for(var b=
this.mapGroup.querySelectorAll("text.poi-label"),c=0;c<b.length;c++){var d=b[c],e=d.attr("data-level");Util.isNull(e)&&(e=0);a?"none"!==d.getStyle("display")&&d.updateStyle("display","none"):this.scale>=e?("none"===d.getStyle("display")&&d.updateStyle("display",""),d.attr("font-size",1/this.scale*12)):"none"!==d.getStyle("display")&&d.updateStyle("display","none")}},_renderFilteredFlights:function(a){if(this._isToggleEnabled("flight")){var b=this;Config.colorIndex=0;a.forEach(function(c){c.forEach(function(d){b.renderFlight(b.mapGroup,
d.from,d.to,d.crossPacific,d.direction)});Config.colorIndex++})}},_renderFilteredRoutes:function(a,b){b&&0!==b.length||(b=Config.WorldMap.defaultProfile.slice());if(this._isToggleEnabled("routes")){var c=this;window.mapdata.routes.forEach(function(d){var e=d.year&&-1!==a.indexOf(d.year),f=c._matchesProfile(d.profile,b);e&&f&&c.renderRouteGroup(c.mapGroup,d.path)})}},_matchesProfile:function(a,b){a&&""!==a.trim()||(a=Config.WorldMap.defaultProfile[0]);a=a.split(",").map(function(e){return e.trim()}).filter(function(e){return 0<
e.length});0===a.length&&(a=Config.WorldMap.defaultProfile);for(var c=0;c<b.length;c++){var d=b[c].trim();if(0!==d.length&&-1===a.indexOf(d))return!1}return!0},_applyCurrentToggleStates:function(){this.frame&&this.frame.toolbar&&(this._isToggleEnabled("flight")||this.showFlights(!1),this._isToggleEnabled("routes")||this.showRoutes(!1))}};
function Toolbar(a){this.frame=a;this.zoomRatio=1;this.naviSpeed={x:0,y:0};this.buttonCount=0;this.yearFilter=this.flightOverlay=this.routesOverlay=this.onNaviRestore=this.onNavigate=this.onZoomRestore=this.onZoom=this.onZoomOut=this.onZoomIn=this.naviGroup=this.toolSub=this.toolGroup=this.scaleGroup=this.naviTimer=this.zoomTimer=null;this.selectedYears=[];this.selectedProfiles=Config.WorldMap.defaultProfile.slice();this.filterCollapsed=!0}
...
"M24,0 L8,16 L24,32"))},null);this.toolSub=this.toolGroup.createChildNS("g",{transform:"translate({0}, {1})".format(Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing,0),style:"display: none"});this.renderButton(this.toolSub,0,0,"M0,16 H10 M14,16 H18 M22,16 H32 M16,0 V10 M16,22 V32",!0,!1,!1,function(d){b.frame.startAnimation(b.frame.map.width/2,b.frame.map.height/2,1)},null);this.flightOverlay=this.renderButton(this.toolSub,0,1,"M29.532,17.258c-0.584-0.985-3.159-2.277-3.602-2.488L18.155,9.53L17.53,2.608C17.438,2.172,16.903,0,15.561,0c-1.376,0-1.833,2.097-1.89,2.394l-0.699,7.468l-7.103,4.973c-0.473,0.243-2.86,1.496-3.396,2.431c-0.482,0.843-0.373,3.24-0.346,3.712c0.01,0.179,0.104,0.342,0.253,0.439c0.15,0.097,0.334,0.118,0.503,0.058l10.24-3.797l0.898,9.151c0,0.112,0.001,0.223,0.006,0.332c-0.91,0.464-2.98,1.59-3.463,2.501c-0.227,0.435-0.134,1.352-0.059,1.859c0.026,0.165,0.122,0.311,0.265,0.396C10.858,31.972,10.959,32,11.062,32c0.063,0,0.124-0.011,0.183-0.031l3.503-1.208h1.621l3.593,1.131c0.159,0.047,0.328,0.029,0.467-0.06c0.14-0.088,0.236-0.231,0.26-0.393c0.083-0.554,0.141-1.291-0.061-1.67c-0.527-0.975-2.805-2.152-3.796-2.629l1.165-9.719l11.15,3.674c0.165,0.055,0.349,0.03,0.495-0.071c0.145-0.099,0.235-0.261,0.243-0.437C29.912,19.992,29.97,17.994,29.532,17.258z M17.845,16.188c-0.055-0.02-0.115-0.029-0.176-0.029h-0.156c-0.285,0-0.525,0.213-0.558,0.496l-1.248,10.443c0,0.097-0.011,0.192-0.028,0.286c-0.043,0.252,0.088,0.501,0.321,0.606c1.318,0.605,3.317,1.722,3.622,2.279c0.017,0.055,0.021,0.181,0.017,0.34l-3.013-0.948c-0.054-0.017-0.111-0.026-0.168-0.026h-1.803c-0.062,0-0.124,0.012-0.183,0.03l-2.92,1.008c-0.012-0.236-0.01-0.426,0.008-0.488c0.287-0.543,2.102-1.604,3.298-2.184c0.212-0.103,0.337-0.326,0.315-0.563c-0.02-0.196-0.025-0.401-0.028-0.669l-0.971-9.93c-0.017-0.174-0.114-0.33-0.261-0.423c-0.09-0.058-0.194-0.087-0.298-0.087c-0.066,0-0.132,0.013-0.195,0.035L3.225,20.147c-0.013-1.012,0.058-2.032,0.223-2.324c0.273-0.476,1.88-1.448,2.999-2.026l7.381-5.162c0.136-0.094,0.222-0.245,0.237-0.409l0.715-7.667c0.134-0.664,0.504-1.432,0.779-1.432c0.226,0,0.669,0.792,0.858,1.652l0.643,7.155c0.019,0.204,0.168,0.373,0.354,0.456l7.956,5.353c1.142,0.559,2.889,1.575,3.193,2.088c0.139,0.233,0.208,1.09,0.21,1.959L17.845,16.188z",
!1,!0,!0,function(d,e,f){b.showFlights("none"==f.attr("stroke"))},null).overlay;this.routesOverlay=this.renderButton(this.toolSub,0,2,"M13.671,13.059c-0.588-1.381-1.096-2.574-0.763-4.564c0.606-3.606,6.876-7.688,13.74-7.338l0.059-1.135c-7.559-0.377-14.231,4.142-14.926,8.287c-0.389,2.315,0.234,3.778,0.837,5.193c0.455,1.066,0.924,2.168,1,3.723c0.12,2.441-7.298,6.35-12.002,8.242l0.429,1.053c1.322-0.531,12.915-5.309,12.717-9.352C14.675,15.414,14.142,14.163,13.671,13.059z M30.352,21.012c-0.238-3.152-1.9-6.189-4.211-7.736C22.1,10.57,21.781,9.129,22.635,7.68c1.965-3.333,7.047-3.382,7.047-3.382V3.162c0,0-5.736,0.045-8.035,3.945c-1.691,2.871,0.908,5.115,3.891,7.112c2.031,1.36,3.48,4.059,3.691,6.877c0.188,2.496-0.465,6.27-4.633,10.066L25.369,32C29.875,27.895,30.557,23.758,30.352,21.012z M14.12,28.92l0.267,1.105c0.025-0.006,0.618-0.148,1.446-0.527l-0.479-1.033C14.637,28.795,14.125,28.918,14.12,28.92z M17.918,13.655c0.461,0.811,0.945,1.683,1.348,2.64l1.057-0.437c-0.428-1.016-0.93-1.92-1.406-2.761L17.918,13.655z M17.545,7.968L16.5,7.505c-0.235,0.527-0.351,1.054-0.351,1.613c0,0.551,0.113,1.125,0.35,1.76l1.073-0.394c-0.188-0.505-0.279-0.952-0.279-1.366C17.293,8.722,17.377,8.346,17.545,7.968zM17.73,26.896l0.779,0.83c0.813-0.75,1.461-1.619,1.932-2.584l-1.029-0.496C19.004,25.484,18.438,26.242,17.73,26.896zM21.209,18.885l-1.129,0.182c0.055,0.342,0.096,0.689,0.119,1.033c0.018,0.266,0.027,0.523,0.027,0.775c0,0.359-0.018,0.717-0.055,1.059l1.139,0.119c0.039-0.383,0.061-0.779,0.061-1.178c0-0.275-0.01-0.559-0.031-0.852C21.314,19.645,21.27,19.26,21.209,18.885z M19.818,4.114c-0.438,0.293-0.84,0.587-1.193,0.874l0.723,0.881c0.326-0.265,0.701-0.539,1.109-0.813L19.818,4.114z",
!1,!0,!0,function(d,e,f){b.showRoutes("none"==f.attr("stroke"))},null).overlay;this.naviGroup=a.createChildNS("g");this.renderButton(this.naviGroup,1,0,"M8,16 L20,24 V8 Z",!0,!1,!1,function(d){b.naviSpeed.x=Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.x=0});this.renderButton(this.naviGroup,0,1,"M16,8 L8,20 H24 Z",!0,!1,!1,function(d){b.naviSpeed.y=Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.y=0});this.renderButton(this.naviGroup,1,2,"M24,16 L12,8 V24 Z",
!0,!1,!1,function(d){b.naviSpeed.x=-Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.x=0});this.renderButton(this.naviGroup,1,1,"M16,24 L24,12 H8 Z",!0,!1,!1,function(d){b.naviSpeed.y=-Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.y=0});this.initProfileFilter();this.initYearFilter()},renderCustomButton:function(a,b,c,d){if(this.toolSub){var e=this,f=++this.buttonCount;this.renderButton(this.toolSub,1,f-1,a,!0,!1,!1,function(g){e.frame.startAnimation(b,c,d)},
null)}},showRoutes:function(a){this.frame.map.showRoutes(a);this.routesOverlay.attr("stroke",a?"#333":"none");Util.setUrlHash("r",a?1:0)},showFlights:function(a){this.frame.map.showFlights(a);this.flightOverlay.attr("stroke",a?"#333":"none");Util.setUrlHash("f",a?1:0)},showPois:function(a){this.frame.map.showPois(a)},getUniqueFlightYears:function(){var a=[];window.mapdata.flights.forEach(function(b){b.forEach(function(c){c.year&&1900<c.year&&-1===a.indexOf(c.year)&&a.push(c.year)})});window.mapdata.pois.forEach(function(b){if(b.year){var c=
[];c="string"===typeof b.year?-1<b.year.indexOf(",")?b.year.split(",").map(function(d){return parseInt(d.trim())}):[parseInt(b.year)]:[b.year];c.forEach(function(d){1900<d&&-1===a.indexOf(d)&&a.push(d)})}});window.mapdata.routes.forEach(function(b){b.year&&1900<b.year&&-1===a.indexOf(b.year)&&a.push(b.year)});return a.sort()},initProfileFilter:function(){var a=Util.getQueryStringByName("profile");this.selectedProfiles=a?a.split(",").map(function(b){return b.trim()}).filter(function(b){return 0<b.length}):
Config.WorldMap.defaultProfile.slice()},applyProfileFilter:function(){var a=Config.WorldMap.defaultProfile;this.selectedProfiles.length===a.length&&this.selectedProfiles.every(function(b,c){return b===a[c]})?Util.setQueryString("profile",""):Util.setQueryString("profile",this.selectedProfiles.join(","))},initYearFilter:function(){var a=this.getUniqueFlightYears();this.selectedYears=a.slice();var b=Util.getUrlHash("years"),c=!1;if(b)if(c=!0,"none"===b)this.selectedYears=[];else try{this.selectedYears=
b.split(",").map(function(d){d=parseInt(d.trim(),10);return 1900<=d&&2100>=d?d:null}).filter(function(d){return null!==d&&-1!==a.indexOf(d)})}catch(d){this.selectedYears=a.slice()}this.renderYearFilter();c||this.selectedYears.length!==a.length?this.applyYearFilter():(b=this.selectedProfiles||Config.WorldMap.defaultProfile.slice(),this.frame.map.filterByYearsAndProfiles(this.selectedYears,b))},renderYearFilter:function(){var a=this.getUniqueFlightYears();0===a.length||this.yearFilter||(this.yearFilter=
this.frame.map.getExtraGroup().createChildNS("g",{id:"year-filter-group",class:"year-filter-svg"}),this._createYearFilterBackground(a),this._createYearCheckboxes(a),this.positionYearFilter())},_createYearFilterBackground:function(a){a=this._getFilterDimensions(a);this.yearFilter.createChildNS("rect",{x:2,y:2,width:a.width,height:a.height,fill:"rgba(0, 0, 0, 0.1)",rx:6,ry:6});this.yearFilter.createChildNS("rect",{x:0,y:0,width:a.width,height:a.height,fill:"rgba(255, 255, 255, 0.97)",stroke:"#bbb",
"stroke-width":1,rx:6,ry:6})},_createYearCheckboxes:function(a){var b=this,c=8;this._createFilterTitleBar(8,c);c+=24;c+=8;c+=10;this.filterCollapsed||(this.createSVGCheckbox(this.yearFilter,13,c,"All Years",this.selectedYears.length===a.length,function(){b._toggleAllYears(a)}),c+=24,a.forEach(function(d){b.createSVGCheckbox(b.yearFilter,13,c,d.toString(),-1!==b.selectedYears.indexOf(d),function(){b._toggleYear(d)});c+=22}),this._addVersionNumber(a))},_getFilterDimensions:function(a){var b=Math.max.apply(Math,
a.concat(["All Years","Years"]).map(function(c){return 9*c.toString().length}));return{width:Math.max(140,32+b+16+8),height:this.filterCollapsed?40:22*a.length+98}},_createFilterTitleBar:function(a,b){var c=this,d=this.getUniqueFlightYears();d=Math.max.apply(Math,d.concat(["All Years","Years"]).map(function(f){return 9*f.toString().length}));var e=Math.max(140,32+d+16+8);d=this.yearFilter.createChildNS("rect",{x:0,y:b,width:e,height:24,fill:"rgba(240, 240, 240, 0.3)",stroke:"none",rx:4,ry:4,style:"cursor: pointer;"});
this.yearFilter.createChildNS("text",{x:a+4,y:b+15,fill:"#333","font-size":"12px","font-family":"Arial, sans-serif","font-weight":"bold"},"Years");a=e-26;e=b+0;b=this.yearFilter.createChildNS("rect",{x:a-6,y:e,width:24,height:24,fill:"transparent",stroke:"none",style:"cursor: pointer;"});a=this.yearFilter.createChildNS("path",{d:this.filterCollapsed?"M3,2 L9,6 L3,10 Z":"M2,3 L6,9 L10,3 Z",fill:"#666",stroke:"none",transform:"translate("+a+", "+(e+6)+")",style:"cursor: pointer;"});e=function(f){f.addEventListener("click",
function(g){g.preventDefault();g.stopPropagation();c._toggleFilterCollapse()});f.addEventListener("touchstart",function(g){g.preventDefault();g.stopPropagation();g._handled=!0});f.addEventListener("touchend",function(g){g.preventDefault();g.stopPropagation();g._handled=!0;c._toggleFilterCollapse()})};e(d);e(b);e(a)},_addVersionNumber:function(a){if(!this.filterCollapsed){a=22*a.length+86;var b=this.yearFilter.querySelector("rect:nth-child(2)");b=b?parseInt(b.getAttribute("width"))/2:70;this.yearFilter.createChildNS("text",
{x:b,y:a,fill:"#999","font-size":"9px","font-family":"Arial, sans-serif","text-anchor":"middle","font-style":"italic"},"v"+Config.version)}},_toggleFilterCollapse:function(){this.filterCollapsed=!this.filterCollapsed;this._refreshYearFilter()},_refreshYearFilter:function(){var a=null;this.yearFilter&&(a=this.yearFilter.getAttribute("transform"),this.yearFilter.parentNode.removeChild(this.yearFilter),this.yearFilter=null);this.renderYearFilter();a&&this.yearFilter&&this.yearFilter.setAttribute("transform",
a)},_toggleAllYears:function(a){this.selectedYears=this.selectedYears.length===a.length?[]:a.slice();this.updateSVGCheckboxes();this.applyYearFilter()},_toggleYear:function(a){var b=this.selectedYears.indexOf(a);-1!==b?this.selectedYears.splice(b,1):this.selectedYears.push(a);this.selectedYears.sort();this.updateSVGCheckboxes();this.applyYearFilter()},positionYearFilter:function(a,b){this.yearFilter&&(a=a||(this.frame&&this.frame.map?this.frame.map.width:1E3),b=this.yearFilter.querySelectorAll("rect"),
b=1<b.length?parseInt(b[1].getAttribute("width")):130,this.yearFilter.attr("transform","translate("+(a-b-15)+", 15)"))},createSVGCheckbox:function(a,b,c,d,e,f){a=a.createChildNS("g",{class:"svg-checkbox","data-label":d});b=this._createCheckboxElements(a,b,c,16,d,e);this._addCheckboxEventHandlers(b.bg,b.text,b.touchArea,f);a.checkmarkElement=b.checkmark;a.isChecked=e;return a},_createCheckboxElements:function(a,b,c,d,e,f){var g=a.createChildNS("rect",{x:b-8,y:c-d-4,width:d+8+(8*e.toString().length+
10)+20,height:28,fill:"transparent",stroke:"none",style:"cursor: pointer"}),l=a.createChildNS("rect",{x:b,y:c-d+2,width:d,height:d,fill:"white",stroke:"#666","stroke-width":1,rx:3,ry:3,style:"cursor: pointer"});f=a.createChildNS("path",{d:"M"+(b+3)+","+(c-6)+" L"+(b+7)+","+(c-2)+" L"+(b+13)+","+(c-10),stroke:"#2c5aa0","stroke-width":2.5,fill:"none","stroke-linecap":"round","stroke-linejoin":"round",style:f?"display: block":"display: none"});a=a.createChildNS("text",{x:b+d+8,y:c,fill:"#333","font-size":"13px",
"font-family":"Arial, sans-serif",style:"cursor: pointer"},e);return{bg:l,checkmark:f,text:a,touchArea:g}},_addCheckboxEventHandlers:function(a,b,c,d){var e=0,f=a.attr("fill"),g=null,l=!1,m=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;g={x:h.clientX,y:h.clientY};l=!1;a.attr("fill","#e6f3ff")},p=function(h){g&&5<Math.abs(h.clientX-g.x)+Math.abs(h.clientY-g.y)&&(l=!0,a.attr("fill",f))},q=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;g&&!l&&d();g=null;l=!1;a.attr("fill",
f)},r=function(h){!g&&300<Date.now()-e&&a.attr("fill","#f0f0f0")},n=function(h){g?(g=null,l=!1,a.attr("fill",f)):300<Date.now()-e&&a.attr("fill",f)},k=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();a.attr("fill","#e6f3ff")},t=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();a.attr("fill",f);d()},u=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();a.attr("fill",f)},v=function(h){h.preventDefault();h.stopPropagation();
h._handled=!0};[a,b,c].forEach(function(h){h.addEventListener("mousedown",m);h.addEventListener("mousemove",p);h.addEventListener("mouseup",q);h.addEventListener("mouseenter",r);h.addEventListener("mouseleave",n);h.addEventListener("touchstart",k,{passive:!1});h.addEventListener("touchend",t,{passive:!1});h.addEventListener("touchcancel",u,{passive:!1});h.addEventListener("touchmove",v,{passive:!1})})},updateSVGCheckboxes:function(){if(this.yearFilter)for(var a=this.getUniqueFlightYears(),b=this.yearFilter.querySelectorAll("g.svg-checkbox"),
c=0;c<b.length;c++){var d=b[c],e=d.getAttribute("data-label");e="All Years"===e?this.selectedYears.length===a.length:-1!==this.selectedYears.indexOf(parseInt(e));d.isChecked=e;d.checkmarkElement&&(d.checkmarkElement.style.display=e?"block":"none")}},updateYearCheckboxes:function(){this.updateSVGCheckboxes()},updateAllCheckbox:function(){this.updateSVGCheckboxes()},applyYearFilter:function(){var a=this.selectedProfiles||Config.WorldMap.defaultProfile.slice();this.frame.map.filterByYearsAndProfiles(this.selectedYears,
a);a=this.getUniqueFlightYears();a=0===this.selectedYears.length?"none":this.selectedYears.length===a.length?"":this.selectedYears.join(",");Util.setUrlHash("years",a);this.applyProfileFilter()},adjustPosition:function(a,b){this.scaleGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:a-Config.Toolbar.marginRight-Config.Toolbar.buttonSize,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}));this.toolGroup.attr("transform",Util.format_str("translate({left}, {top})",
{left:Config.Toolbar.marginLeft,top:Config.Toolbar.marginTop}));this.naviGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:Config.Toolbar.marginLeft,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}));this.positionYearFilter(a,b)},renderButton:function(a,b,c,d,e,f,g,l,m){var p=this,q=0;a=a.createChildNS("g",{transform:"translate({0}, {1})".format((Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)*c,(Config.Toolbar.buttonSize+
Config.Toolbar.buttonSpacing)*b)});var r=a.createChildNS("path",{fill:f?"RGBA(0,0,0,1)":"none",stroke:e?"RGBA(0,0,0,1)":"none","stroke-width":4,"stroke-linejoin":"round",d:d,transform:"translate({0}, {0})".format(Config.Toolbar.buttonPadding)}),n=a.createChildNS("rect",{fill:"RGBA(255,255,255,0.4)",stroke:g?"#333":"none","stroke-width":1,x:0,y:0,rx:Config.Toolbar.buttonSize/8,ry:Config.Toolbar.buttonSize/8,width:Config.Toolbar.buttonSize,height:Config.Toolbar.buttonSize});n.addEventListener("touchstart",
function(k){k.preventDefault();k.stopPropagation();k._handled=!0;q=Date.now();p.highlightIcon(this.parentNode.childNodes[0],!0);"function"===typeof l&&l(k,r,n)},!0);n.addEventListener("touchend",function(k){k.preventDefault();k.stopPropagation();k._handled=!0;q=Date.now();p.highlightIcon(this.parentNode.childNodes[0],!1);"function"===typeof m&&m(k,r,n)},!0);n.addEventListener("touchcancel",function(k){k.preventDefault();k.stopPropagation();k._handled=!0;q=Date.now();p.highlightIcon(this.parentNode.childNodes[0],
!1);"function"===typeof m&&m(k,r,n)},!0);n.addEventListener("touchmove",function(k){k.preventDefault();k.stopPropagation();k._handled=!0},!0);n.addEventListener("mousedown",function(k){500>Date.now()-q||(p.highlightIcon(this.parentNode.childNodes[0],!0),"function"===typeof l&&l(k,r,n),k.stopPropagation())},!0);n.addEventListener("mouseup",function(k){500>Date.now()-q||(p.highlightIcon(this.parentNode.childNodes[0],!1),"function"===typeof m&&m(k,r,n),k.stopPropagation())},!0);n.addEventListener("mouseout",
function(k){500>Date.now()-q||(p.highlightIcon(this.parentNode.childNodes[0],!1),"function"===typeof m&&m(k,r,n),k.stopPropagation())},!0);n.addEventListener("mousemove",function(k){k.stopPropagation()},!0);return{icon:r,overlay:n}},startZoomTimer:function(){var a=this;this.zoomTimer&&(clearTimeout(this.zoomTimer),this.zoomTimer=null);var b=function(){1!==a.zoomRatio&&"function"===typeof a.onZoom?(requestAnimationFrame(function(){a.onZoom(a.zoomRatio)}),a.zoomTimer=setTimeout(b,Config.Toolbar.zoomTimerDelay)):
a.zoomTimer=null};b()},startNaviTimer:function(){var a=this;this.naviTimer&&(clearTimeout(this.naviTimer),this.naviTimer=null);var b=function(){0===a.naviSpeed.x&&0===a.naviSpeed.y||"function"!==typeof a.onNavigate?a.naviTimer=null:(requestAnimationFrame(function(){a.onNavigate(a.naviSpeed.x,a.naviSpeed.y)}),a.naviTimer=setTimeout(b,Config.Toolbar.navTimerDelay))};b()},highlightIcon:function(a,b){"none"!=a.attr("stroke")&&a.attr("stroke",b?"#ff0000":"#000000");"none"!=a.attr("fill")&&a.attr("fill",
b?"#ff0000":"#000000")}};
