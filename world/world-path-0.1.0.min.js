...
var Util={$:function(){for(var a=[],b=0;b<arguments.length;b++){var c=arguments[b];"string"==typeof c&&(c=document.getElementById(c));if(1==arguments.length)return c;a.push(c)}return a},getQueryStringByName:function(a,b){null==b&&(b=location.search);a=b.match(new RegExp("[?&]"+a+"=([^&]+)","i"));return null==a||1>a.length?null:a[1]},setUrlHash:function(a,b){var c=window.location.hash;if(0>=c.length)window.location.hash=a+"="+b;else{var d=a+"=([^&]*)",f=c.match(new RegExp(d,"i")),e=c;null==f||1>f.length?
""!==b&&(e=c+"&"+a+"="+b):""===b?(e=c.replace(new RegExp("&?"+a+"=([^&]*)&?","i"),function(g,k,h,m){if(0===g.indexOf("&")&&"&"===g.charAt(g.length-1))return"&";0!==g.indexOf("&")&&g.charAt(g.length-1);return""}),e=e.replace(/&&+/g,"&"),e=e.replace(/#&/,"#")):e=c.replace(new RegExp(d,"i"),a+"="+b);history.replaceState(void 0,void 0,e)}},getUrlHash:function(a,b){null==b&&(b=window.location.hash);a=b.match(new RegExp("[#&]"+a+"=([^&]+)","i"));return null==a||1>a.length?null:a[1]},isNull:function(a){return"undefined"==
a||null==a},is:function(a,b){b=String.prototype.toLowerCase.call(b);return"finite"==b?isFinite(a):"array"==b&&(a instanceof Array||Array.isArray&&Array.isArray(a))?!0:"null"==b&&null===a||b==typeof a&&null!==a||"object"==b&&a===Object(a)||Object.prototype.toString.call(a).slice(8,-1).toLowerCase()==b},format_str:function(){var a=/\{([^\}]+)\}/g,b=/(?:(?:^|\.)(.+?)(?=\[|\.|$|\()|\[('|")(.+?)\2\])(\(\))?/g,c=function(d,f,e){var g=e;f.replace(b,function(k,h,m,p,n){h=h||p;g&&(h in g&&(g=g[h]),"function"==
typeof g&&n&&(g=g()))});return g=(null==g||g==e?d:g)+""};return function(d,f){return String(d).replace(a,function(e,g){return c(e,g,f)})}}()},Browser={versions:function(){var a=navigator.userAgent;return{trident:-1<a.indexOf("Trident"),presto:-1<a.indexOf("Presto"),webKit:-1<a.indexOf("AppleWebKit"),gecko:-1<a.indexOf("Gecko")&&-1==a.indexOf("KHTML"),mobile:!!a.match(/AppleWebKit.*Mobile.*/),ios:!!a.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/),android:-1<a.indexOf("Android")||-1<a.indexOf("Linux"),iPhone:-1<
a.indexOf("iPhone"),iPad:-1<a.indexOf("iPad"),webApp:-1==a.indexOf("Safari")}}(),language:(navigator.browserLanguage||navigator.language).toLowerCase()};Element.prototype.attr=function(a,b){if(!a){if(1!=this.nodeType)return{text:this.nodeValue};for(var c=this.attributes,d={},f=0,e=c.length;f<e;f++)d[c[f].nodeName]=c[f].nodeValue;return d}if(Util.is(a,"string"))if(1<arguments.length)c={},c[a]=b,a=c;else return this.getAttribute(a);for(d in a)a.hasOwnProperty(d)&&this.setAttribute(d,a[d]);return this};
Element.prototype.createChildNS=function(a,b,c,d){a=document.createElementNS("http://www.w3.org/2000/svg",a);d&&this.hasChildNodes()?this.insertBefore(a,this.firstChild):this.appendChild(a);if(b)for(var f in b)a.setAttribute(f,b[f]);c&&(a.textContent=c);return a};Element.prototype.getStyle=function(a){var b=this.getAttribute("style");if(null!=b&&0<b.trim().length){b=b.split(";");for(var c=0;c<b.length&&0<b[c].trim().length;c++){var d=b[c].split(":");if(2==d.length&&a==d[0].trim())return d[1].trim()}}return null};
Element.prototype.updateStyle=function(a,b){var c=this.getAttribute("style"),d=!1,f="";if(null!=c&&0<c.trim().length){c=c.split(";");for(var e=0;e<c.length&&0<c[e].trim().length;e++){var g=c[e].split(":");2==g.length&&(a==g[0].trim()?(d=!0,null!=b&&(f+=a+": "+b+"; ")):f+=g[0].trim()+": "+g[1].trim()+"; ")}}d||(f+=a+": "+b+"; ");this.setAttribute("style",f)};Array.prototype.each=function(a,b){b=this.findItem(b);for(var c=0;c<b.length;c++)"function"==typeof a&&a.call(b[c])};
...
Frame.prototype={moveMapTo:function(a,b,c){var d=this;if(!this.inMotion){this.inMotion=!0;var f=Config.WorldMap.moveDuration/Config.WorldMap.moveTimerDelay,e=Math.round((a-this.map.left)/f),g=Math.round((b-this.map.top)/f),k=function(){if(d.map.left==a&&d.map.top==b)d.inMotion=!1,"function"==typeof c&&c();else{var h=d.map.left+e,m=d.map.top+g;if(0==e||0<e&&h>a||0>e&&h<a)h=a;if(0==g||0<g&&m>b||0>g&&m<b)m=b;d.map.moveTo(h,m,null);setTimeout(k,Config.WorldMap.moveTimerDelay)}};k()}},scaleMapTo:function(a,
b){var c=this;if(!this.inMotion){this.inMotion=!0;a<Config.WorldMap.minScale?a=Config.WorldMap.minScale:a>Config.WorldMap.maxScale&&(a=Config.WorldMap.maxScale);var d=a>this.map.scale?1.1:.9,f=function(){if(c.map.scale==a)c.inMotion=!1,"function"==typeof b&&b();else{var e=c.map.scale*d;if(1>d&&e<a||1<d&&e>a)e=a;var g=c.convertFramePointToMap(c.width/2,c.height/2);c.map.zoomTo(e,g);setTimeout(f,Config.WorldMap.zoomTimerDelay)}};f()}},setCenterAndScale:function(a,b,c,d){var f=this;this.scaleMapTo(1,
function(){f.setCenterPoint(a,b,!0,function(){f.scaleMapTo(c,function(){"function"==typeof d&&d()})})})},setCenterPoint:function(a,b,c,d){a=this.width/2-a*this.map.scale;b=this.height/2-b*this.map.scale;c?this.moveMapTo(a,b,d):(this.map.moveTo(a,b),"function"==typeof d&&d())},getCenterPoint:function(){return{cx:(this.width/2-this.map.left)/this.map.scale,cy:(this.height/2-this.map.top)/this.map.scale}},renderInto:function(a,b){var c=this;this.frameObj=document.createElement("div");var d=Util.format_str("width: {width}px; height: {height}px; cursor: pointer; overflow: hidden; border: none; background-color: RGBA(100, 100, 100, 0.2);",
{width:this.width,height:this.height});this.frameObj.setAttribute("style",d);a.appendChild(this.frameObj);this.toolbar=new Toolbar(this);this.map.renderInto(this.frameObj,function(){c.enableInteractive();c.toolbar.renderInto(c.map.getExtraGroup());c.statusLabel=c.map.getExtraGroup().createChildNS("text",{fill:"#666",class:"no-select",x:4,y:10,"font-size":8});var e=Util.getUrlHash("cx"),g=Util.getUrlHash("cy"),k=Util.getUrlHash("s");null!=e&&null!=g?c.setCenterPoint(e,g,!1,function(){if(null!=k){var h=
c.convertFramePointToMap(c.width/2,c.height/2);c.map.zoomTo(k,h)}}):(c.setCenterPoint(c.map.width/2,c.map.height/2,!1,null),c.updateStatusLabel());e=Util.getUrlHash("r");g=Util.getUrlHash("f");0==e&&c.toolbar.showRoutes(!1);0==g&&c.toolbar.showFlights(!1);(e=Util.getUrlHash("years"))&&""!==e&&c.toolbar.applyYearFilter();"function"==typeof b&&b()});this.toolbar.onZoom=function(e){var g=c.convertFramePointToMap(c.width/2,c.height/2);return c.map.zoom(e,g)};this.toolbar.onZoomRestore=function(){c.scaleMapTo(1,
null)};this.toolbar.onNavigate=function(e,g){c.map.move(e,g)};this.toolbar.onNaviRestore=function(){c.setCenterPoint(c.map.width/2,c.map.height/2,!0,null)};this.map.onScaleChanged=function(){c.updateStatusLabel()};this.map.onPositionChanged=function(){c.updateStatusLabel()};if(this.fullscreen){var f=function(){c.map.resize(c.width,c.height);c.toolbar.adjustPosition(c.width,c.height)};setInterval(function(e){e=document.documentElement.clientWidth;var g=document.documentElement.clientHeight;if(e!=c.width||
g!=c.height)c.width=e,c.height=g,c.frameObj.style.width=c.width+"px",c.frameObj.style.height=c.height+"px",f()},200);f()}else this.toolbar.adjustPosition(this.width,this.height)},updateStatusLabel:function(){this.statusLabel.textContent="[{0}, {1}] x {2}".format(this.map.left.toFixed(1),this.map.top.toFixed(1),this.map.scale.toFixed(1));var a=this.getCenterPoint();Util.setUrlHash("cx",a.cx.toFixed(3));Util.setUrlHash("cy",a.cy.toFixed(3));Util.setUrlHash("s",this.map.scale.toFixed(3))},enableInteractive:function(){var a=
this;this.handleTouchEvent=function(b){if(!a.inMotion)switch(b.preventDefault(),b.type){case "touchstart":if(1==b.touches.length)a.eventDown(b.targetTouches[0]);else if(2==b.touches.length){var c=b.targetTouches[0];b=b.targetTouches[1];a.startDistance=a.getDistance(c.pageX,c.pageY,b.pageX,b.pageY)}break;case "touchmove":1==b.changedTouches.length?a.eventMove(b.changedTouches[0]):2==b.touches.length&&(c=b.targetTouches[0],b=b.targetTouches[1],c=a.getDistance(c.pageX,c.pageY,b.pageX,b.pageY),a.map.zoom(c>
a.startDistance?1:-1),a.startDistance=c);break;case "touchend":1==b.changedTouches.length&&a.eventUp(b.changedTouches[0])}};this.frameObj.addEventListener("touchstart",this.handleTouchEvent,!1);this.frameObj.addEventListener("touchend",this.handleTouchEvent,!1);this.frameObj.addEventListener("touchmove",this.handleTouchEvent,!1);this.handleMouseEvent=function(b){if(!a.inMotion)switch(b.preventDefault(),b.type){case "mousedown":a.eventDown(b);break;case "mousemove":a.eventMove(b);break;case "mouseup":a.eventUp(b);
break;case "mouseleave":a.isHolding=!1;break;case "mousewheel":var c=a.getEventPositionOnMap(b,a.frameObj);a.map.zoom(0<b.wheelDelta?1.1:.9,c)}};this.frameObj.addEventListener("mousedown",this.handleMouseEvent,!1);this.frameObj.addEventListener("mousemove",this.handleMouseEvent,!1);this.frameObj.addEventListener("mouseup",this.handleMouseEvent,!1);this.frameObj.addEventListener("mouseleave",this.handleMouseEvent,!1);this.frameObj.addEventListener("dblclick",this.handleMouseEvent,!1);this.frameObj.addEventListener("mousewheel",
this.handleMouseEvent,!1);this.handleKeyEvent=function(b){a.inMotion||a.handleKey(b,a)};document.addEventListener("keydown",this.handleKeyEvent,!1);document.addEventListener("keyup",this.handleKeyEvent,!1)},eventDown:function(a){this.isHolding=!0;this.mousePoint.x=a.pageX;this.mousePoint.y=a.pageY},eventUp:function(a){this.isHolding=!1},eventMove:function(a){!this.isHolding||void 0!=a.layerX&&(Browser.versions.iPhone||Browser.versions.iPad)||(this.map.move(a.pageX-this.mousePoint.x,a.pageY-this.mousePoint.y),
this.mousePoint.x=a.pageX,this.mousePoint.y=a.pageY)},handleKey:function(a){var b=this,c=a.keyCode;switch(a.type){case "keydown":var d=function(){var f=Config.keyboard.changeUnit,e=0,g=0;0<(b.arrowKeyStatus&1)&&(e+=f);0<(b.arrowKeyStatus&2)&&(g+=f);0<(b.arrowKeyStatus&4)&&(e-=f);0<(b.arrowKeyStatus&8)&&(g-=f);0<b.arrowKeyStatus?(b.map.move(e,g),b.keyboardTimer=setTimeout(d,Config.keyboard.timerDelay)):b.keyboardTimer=null};switch(c){case 37:case 65:this.arrowKeyStatus|=1;break;case 38:case 87:this.arrowKeyStatus|=
2;break;case 39:case 68:this.arrowKeyStatus|=4;break;case 40:case 83:this.arrowKeyStatus|=8}0<this.arrowKeyStatus&&null==this.keyboardTimer&&d();break;case "keyup":switch(c){case 37:case 65:b.arrowKeyStatus&=-2;break;case 38:case 87:b.arrowKeyStatus&=-3;break;case 39:case 68:b.arrowKeyStatus&=-5;break;case 40:case 83:b.arrowKeyStatus&=-9}0==b.arrowKeyStatus&&null!=b.keyboardTimer&&(clearTimeout(b.keyboardTimer),b.keyboardTimer=null)}},getDistance:function(a,b,c,d){return-1*Math.sqrt((c-a)*(c-a)+(d-
b)*(d-b))},getEventPositionOnMap:function(a){return{x:a.pageX-this.frameObj.offsetLeft-this.map.left,y:a.pageY-this.frameObj.offsetTop-this.map.top}},convertFramePointToMap:function(a,b){return{x:a-this.frameObj.offsetLeft-this.map.left,y:b-this.frameObj.offsetLeft-this.map.top}},home:function(){var a=this.map.getPoiPosition("SHA");this.setCenterAndScale(a.x,a.y,Config.WorldMap.maxScale,function(){console.log("DONE")})},addCustomButton:function(a,b,c,d){this.toolbar&&this.toolbar.renderCustomButton(a,
b,c,d)}};function WorldMap(){this.parent=this.frame=null;this.width=1E3;this.height=400;this.scale=1;this.top=this.left=0;this.onPositionChanged=this.onScaleChanged=this.extraGroup=this.mapGroup=this.svg=null}
...
this.renderGhostCountry(this.mapGroup,"TW",-this.width);this.renderGhostCountry(this.mapGroup,"KR",-this.width);this.renderGhostCountry(this.mapGroup,"JP",-this.width);a.createChildNS("path",{d:Util.format_str("M0,0 H{width} V{height} H0 Z",{width:this.width,height:this.height}),stroke:"#000000",fill:"none","stroke-width":1,"stroke-opacity":.2,"stroke-dasharray":"5,5",class:"border"})},renderGhostCountry:function(a,b,c){var d=this;a=a.createChildNS("path",{d:worldmap.shapes[b],stroke:"RGBA(127,127,127, 0.4)",
fill:"RGBA(255,255,255,0.1)","stroke-opacity":.6,"stroke-width":1,class:"country",transform:Util.format_str("translate({left},0)",{left:c})});var f=function(){d.frame.moveMapTo(d.left+c*d.scale,d.top,null)};a.addEventListener("mousedown",function(){f()},!1);a.addEventListener("touchstart",function(){f()},!1)},renderPois:function(a){var b=this;window.mapdata.pois.forEach(function(c){b.renderPoi(a,c,0);"ORD"!=c.key&&"LAX"!=c.key&&"SFO"!=c.key&&"YVR"!=c.key&&"YYZ"!=c.key&&"JFK"!=c.key||b.renderPoi(a,
c,b.width);"SHA"!=c.key&&"NRT"!=c.key&&"ICN"!=c.key||b.renderPoi(a,c,-b.width)})},renderPoi:function(a,b,c){var d=b.label,f=b.level,e=this.parseLatLon(b.latlon);b=e.x;e=e.y;null!=c&&0!=c&&(b+=c);a.createChildNS("circle",{cx:b,cy:e,r:0,fill:"#E66C0F",stroke:"none",class:"poi-circle"});a.createChildNS("text",{x:b,y:e,fill:"#000000",stroke:"none","font-size":1/this.scale*12,class:"poi-label",style:"display: none","data-level":f},d)},getControlPoint:function(a,b,c,d){var f=(a.x+b.x)/2;b=(a.y+b.y)/2;var e=
Math.sqrt(Math.pow(a.x-f,2)+Math.pow(a.y-b,2));c*=e;var g={x:(a.y-b)*c/e+f,y:(f-a.x)*c/e+b};a={x:(b-a.y)*c/e+f,y:(a.x-f)*c/e+b};return 0<Math.atan2(g.y-b,g.x-f)*d?g:a},drawFlightLine:function(a,b,c,d){0==d?(this.drawFlightLine(a,b,c,-1),this.drawFlightLine(a,b,c,1)):(d=this.getControlPoint(b,c,.6,d),a.createChildNS("path",{d:Util.format_str("M{from.x},{from.y} Q{control.x},{control.y} {to.x},{to.y}",{from:{x:b.x,y:b.y},control:{x:d.x,y:d.y},to:{x:c.x,y:c.y}}),fill:"none",stroke:Config.colors[Config.colorIndex%
Config.colors.length],"stroke-width":1,class:"flight"}))},renderFlight:function(a,b,c,d,f){b=this.getPoiPosition(b);c=this.getPoiPosition(c);d?(d={x:b.x>c.x?b.x-this.width:this.width+b.x,y:b.y},this.drawFlightLine(a,b,{x:b.x>c.x?this.width+c.x:c.x-this.width,y:c.y},f),this.drawFlightLine(a,d,c,f)):this.drawFlightLine(a,b,c,f)},renderRouteGroup:function(a,b){var c=this,d="";b.forEach(function(f){f=0<f.indexOf(",")?c.parseLatLon(f):c.getPoiPosition(f);d=0<d.length?d+" L{0},{1}".format(f.x,f.y):d+"M{0},{1}".format(f.x,
f.y)});a.createChildNS("path",{d:d,fill:"none",stroke:"#ff0000","stroke-width":1,"stroke-dasharray":"2,2",class:"route"})},renderFlightsAndRoutes:function(a){var b=this;window.mapdata.flights.forEach(function(c){c.forEach(function(d){b.renderFlight(a,d.from,d.to,d.crossPacific,d.direction)});Config.colorIndex++});window.mapdata.routes.forEach(function(c){b.renderRouteGroup(a,c.path)})},zoom:function(a,b){if(this.scale<Config.WorldMap.minScale&&1>a||this.scale>Config.WorldMap.maxScale&&1<a)return!1;
var c=b.x*(1-a);b=b.y*(1-a);this.scale*=a;this.move(c,b)||this.updateTransform();if("function"==typeof this.onScaleChanged)this.onScaleChanged();return!0},zoomTo:function(a,b){return this.zoom(a/this.scale,b)},move:function(a,b){if(0==a&&0==b)return!1;this.moveTo(this.left+a,this.top+b,null);return!0},moveTo:function(a,b){this.left=a;this.top=b;this.updateTransform();if("function"==typeof this.onPositionChanged)this.onPositionChanged()},showFlights:function(a){for(var b=this.mapGroup.querySelectorAll("path.flight"),
c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")},filterByYears:function(a){if(a&&0!==a.length){for(var b=this.mapGroup.querySelectorAll("path.flight"),c=0;c<b.length;c++)b[c].parentNode.removeChild(b[c]);b=this.mapGroup.querySelectorAll("path.route");for(c=0;c<b.length;c++)b[c].parentNode.removeChild(b[c]);b=this.mapGroup.querySelectorAll("circle.poi-circle, text.poi-label");for(c=0;c<b.length;c++)b[c].parentNode.removeChild(b[c]);var d=this,f=[];window.mapdata.flights.forEach(function(e){var g=
[];e.forEach(function(k){k.year?-1!==a.indexOf(k.year)&&g.push(k):g.push(k)});0<g.length&&f.push(g)});Config.colorIndex=0;f.forEach(function(e){e.forEach(function(g){d.renderFlight(d.mapGroup,g.from,g.to,g.crossPacific,g.direction)});Config.colorIndex++});window.mapdata.routes.forEach(function(e){e.year&&-1!==a.indexOf(e.year)?d.renderRouteGroup(d.mapGroup,e.path):e.year||d.renderRouteGroup(d.mapGroup,e.path)});window.mapdata.pois.forEach(function(e){var g=!1;if(e.year){var k=[];k="string"===typeof e.year?
-1<e.year.indexOf(",")?e.year.split(",").map(function(m){return parseInt(m.trim())}):[parseInt(e.year)]:[e.year];for(var h=0;h<k.length;h++)if(-1!==a.indexOf(k[h])){g=!0;break}}else g=!0;g&&(d.renderPoi(d.mapGroup,e,0),"ORD"!=e.key&&"LAX"!=e.key&&"SFO"!=e.key&&"YVR"!=e.key&&"YYZ"!=e.key&&"JFK"!=e.key||d.renderPoi(d.mapGroup,e,d.width),"SHA"!=e.key&&"NRT"!=e.key&&"ICN"!=e.key||d.renderPoi(d.mapGroup,e,-d.width))});this.updateTransform()}else this.showFlights(!1),this.showRoutes(!1),this.showPois(!1)},
showRoutes:function(a){for(var b=this.mapGroup.querySelectorAll("path.route"),c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")},showPois:function(a){for(var b=this.mapGroup.querySelectorAll("circle.poi-circle, text.poi-label"),c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")},restoreOriginalRendering:function(){for(var a=this.mapGroup.querySelectorAll("path.flight"),b=0;b<a.length;b++)a[b].parentNode.removeChild(a[b]);a=this.mapGroup.querySelectorAll("path.route");for(b=0;b<
a.length;b++)a[b].parentNode.removeChild(a[b]);a=this.mapGroup.querySelectorAll("circle.poi-circle, text.poi-label");for(b=0;b<a.length;b++)a[b].parentNode.removeChild(a[b]);Config.colorIndex=0;this.renderFlightsAndRoutes(this.mapGroup);this.renderPois(this.mapGroup);this.updateTransform()},getPoi:function(a){for(var b=0;b<window.mapdata.pois.length;b++)if(window.mapdata.pois[b].key==a)return window.mapdata.pois[b];return null},getPoiPosition:function(a){a=this.getPoi(a);return null!=a?this.parseLatLon(a.latlon):
{x:0,y:0}},getXY:function(a,b){return{x:2.6938*b+465.4,y:-2.6938*a+227.066}},getLatLon:function(a,b){return{lat:(b-227.066)/-2.6938,lon:(a-465.4)/2.6938}},parseLatLon:function(a){var b=(a=String(a).split(/(\d+(?:\.\d+)?)[\xb0\s]?\s*(?:(\d+(?:\.\d+)?)['\u2019\u2032\s])?\s*(?:(\d+(?:\.\d+)?)["\u201d\u2033\s])?\s*([SNEW])?/i))&&+a[1]+(a[2]||0)/60+(a[3]||0)/3600;"S"==a[4].toUpperCase()&&(b=-b);var c=a&&+a[6]+(a[7]||0)/60+(a[8]||0)/3600;"W"==a[9].toUpperCase()&&(c=-c);return this.getXY(b,c)},getScreenCeterPointOnMap:function(){console.log(this.parent.width)}};
function Toolbar(a){this.frame=a;this.zoomRatio=0;this.naviSpeed={x:0,y:0};this.buttonCount=0;this.yearFilter=this.flightOverlay=this.routesOverlay=this.onNaviRestore=this.onNavigate=this.onZoomRestore=this.onZoom=this.onZoomOut=this.onZoomIn=this.naviGroup=this.toolSub=this.toolGroup=this.scaleGroup=null;this.selectedYears=[]}
...
2*Config.Toolbar.buttonPadding)/2,iconSize:Config.Toolbar.buttonSize-2*Config.Toolbar.buttonPadding});this.renderButton(this.scaleGroup,1,0,c,!0,!1,!1,function(d){b.zoomRatio=.9;b.startZoomTimer()},function(d){b.zoomRatio=1});this.toolGroup=a.createChildNS("g");this.renderButton(this.toolGroup,0,0,"M8,0 L24,16 L8,32",!0,!1,!1,function(d,f,e){null==b.toolSub.getStyle("display")?(b.toolSub.updateStyle("display","none"),f.attr("d","M8,0 L24,16 L8,32")):(b.toolSub.updateStyle("display",null),f.attr("d",
...
this.selectedYears=a.slice();var b=Util.getUrlHash("years");if(b)if("none"===b)this.selectedYears=[];else try{this.selectedYears=b.split(",").map(function(c){return parseInt(c)}).filter(function(c){return-1!==a.indexOf(c)})}catch(c){this.selectedYears=a.slice()}this.renderYearFilter()},renderYearFilter:function(){var a=this,b=this.getUniqueFlightYears();if(0!==b.length&&!this.yearFilter){this.yearFilter=document.createElement("div");this.yearFilter.style.position="absolute";this.yearFilter.style.top=
"10px";this.yearFilter.style.right="10px";this.yearFilter.style.background="rgba(255, 255, 255, 0.9)";this.yearFilter.style.border="1px solid #ccc";this.yearFilter.style.borderRadius="4px";this.yearFilter.style.padding="8px";this.yearFilter.style.fontSize="12px";this.yearFilter.style.fontFamily="Arial, sans-serif";this.yearFilter.style.maxHeight="400px";this.yearFilter.style.overflowY="auto";this.yearFilter.style.zIndex="1000";var c=document.createElement("div");c.style.marginBottom="4px";var d=document.createElement("input");
d.type="checkbox";d.id="year-all";d.checked=this.selectedYears.length===b.length;d.addEventListener("change",function(){a.selectedYears=this.checked?b.slice():[];a.updateYearCheckboxes();a.applyYearFilter()});var f=document.createElement("label");f.htmlFor="year-all";f.textContent="All Years";f.style.marginLeft="4px";c.appendChild(d);c.appendChild(f);this.yearFilter.appendChild(c);b.forEach(function(e){var g=document.createElement("div");g.style.marginBottom="2px";var k=document.createElement("input");
k.type="checkbox";k.id="year-"+e;k.value=e;k.checked=-1!==a.selectedYears.indexOf(e);k.addEventListener("change",function(){var m=parseInt(this.value);this.checked?-1===a.selectedYears.indexOf(m)&&a.selectedYears.push(m):(m=a.selectedYears.indexOf(m),-1!==m&&a.selectedYears.splice(m,1));a.selectedYears.sort();a.updateAllCheckbox();a.applyYearFilter()});var h=document.createElement("label");h.htmlFor="year-"+e;h.textContent=e.toString();h.style.marginLeft="4px";g.appendChild(k);g.appendChild(h);a.yearFilter.appendChild(g)});
this.frame.frameObj.appendChild(this.yearFilter)}},updateYearCheckboxes:function(){var a=this;this.getUniqueFlightYears().forEach(function(b){var c=document.getElementById("year-"+b);c&&(c.checked=-1!==a.selectedYears.indexOf(b))});this.updateAllCheckbox()},updateAllCheckbox:function(){var a=document.getElementById("year-all");if(a){var b=this.getUniqueFlightYears();a.checked=this.selectedYears.length===b.length}},applyYearFilter:function(){var a=this.getUniqueFlightYears();this.selectedYears.length===
a.length?(this.frame.map.restoreOriginalRendering(),Util.setUrlHash("years","")):(this.frame.map.filterByYears(this.selectedYears),a=0<this.selectedYears.length?this.selectedYears.join(","):"none",Util.setUrlHash("years",a))},adjustPosition:function(a,b){this.scaleGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:a-Config.Toolbar.marginRight-Config.Toolbar.buttonSize,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}));this.toolGroup.attr("transform",
Util.format_str("translate({left}, {top})",{left:Config.Toolbar.marginLeft,top:Config.Toolbar.marginTop}));this.naviGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:Config.Toolbar.marginLeft,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}))},renderButton:function(a,b,c,d,f,e,g,k,h){var m=this;a=a.createChildNS("g",{transform:"translate({0}, {1})".format((Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)*c,(Config.Toolbar.buttonSize+
Config.Toolbar.buttonSpacing)*b)});var p=a.createChildNS("path",{fill:e?"RGBA(0,0,0,1)":"none",stroke:f?"RGBA(0,0,0,1)":"none","stroke-width":4,"stroke-linejoin":"round",d:d,transform:"translate({0}, {0})".format(Config.Toolbar.buttonPadding)}),n=a.createChildNS("rect",{fill:"RGBA(255,255,255,0.4)",stroke:g?"#333":"none","stroke-width":1,x:0,y:0,rx:Config.Toolbar.buttonSize/8,ry:Config.Toolbar.buttonSize/8,width:Config.Toolbar.buttonSize,height:Config.Toolbar.buttonSize});n.addEventListener("touchstart",
function(l){l.preventDefault();m.highlightIcon(this.parentNode.childNodes[0],!0);"function"==typeof k&&k(l,p,n);l.stopPropagation()},!0);n.addEventListener("touchend",function(l){l.preventDefault();m.highlightIcon(this.parentNode.childNodes[0],!1);"function"==typeof h&&h(l,p,n);l.stopPropagation()},!0);n.addEventListener("touchcancel",function(l){l.preventDefault();m.highlightIcon(this.parentNode.childNodes[0],!1);"function"==typeof h&&h(l,p,n);l.stopPropagation()},!0);n.addEventListener("touchmove",
function(l){l.preventDefault();l.stopPropagation()},!0);n.addEventListener("mousedown",function(l){m.highlightIcon(this.parentNode.childNodes[0],!0);"function"==typeof k&&k(l,p,n);l.stopPropagation()},!0);n.addEventListener("mouseup",function(l){m.highlightIcon(this.parentNode.childNodes[0],!1);"function"==typeof h&&h(l,p,n);l.stopPropagation()},!0);n.addEventListener("mouseout",function(l){m.highlightIcon(this.parentNode.childNodes[0],!1);"function"==typeof h&&h(l,p,n);l.stopPropagation()},!0);n.addEventListener("mousemove",
function(l){l.stopPropagation()},!0);return{icon:p,overlay:n}},startZoomTimer:function(){var a=this,b=function(){1!=a.zoomRatio&&"function"==typeof a.onZoom&&a.onZoom(a.zoomRatio)&&setTimeout(b,Config.Toolbar.zoomTimerDelay)};b()},startNaviTimer:function(){var a=this,b=function(){0==a.naviSpeed.x&&0==a.naviSpeed.y||"function"!=typeof a.onZoom||(a.onNavigate(a.naviSpeed.x,a.naviSpeed.y),setTimeout(b,Config.Toolbar.navTimerDelay))};b()},highlightIcon:function(a,b){"none"!=a.attr("stroke")&&a.attr("stroke",
b?"#ff0000":"#000000");"none"!=a.attr("fill")&&a.attr("fill",b?"#ff0000":"#000000")}};
