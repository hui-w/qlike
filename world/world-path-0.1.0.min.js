...
var Util={$:function(){for(var a=[],b=0;b<arguments.length;b++){var c=arguments[b];"string"==typeof c&&(c=document.getElementById(c));if(1==arguments.length)return c;a.push(c)}return a},getQueryStringByName:function(a,b){null==b&&(b=location.search);a=b.match(new RegExp("[?&]"+a+"=([^&]+)","i"));return null==a||1>a.length?null:a[1]},setUrlHash:function(a,b){var c=window.location.hash;if(0>=c.length)window.location.hash=a+"="+b;else{var d=a+"=([^&]*)",e=c.match(new RegExp(d,"i")),g=c;null==e||1>e.length?
""!==b&&(g=c+"&"+a+"="+b):""===b?(g=c.replace(new RegExp("&?"+a+"=([^&]*)&?","i"),function(f,l,n,q){if(0===f.indexOf("&")&&"&"===f.charAt(f.length-1))return"&";0!==f.indexOf("&")&&f.charAt(f.length-1);return""}),g=g.replace(/&&+/g,"&"),g=g.replace(/#&/,"#")):g=c.replace(new RegExp(d,"i"),a+"="+b);history.replaceState(void 0,void 0,g)}},getUrlHash:function(a,b){null==b&&(b=window.location.hash);a=b.match(new RegExp("[#&]"+a+"=([^&]+)","i"));return null==a||1>a.length?null:a[1]},isNull:function(a){return"undefined"==
a||null==a},is:function(a,b){b=String.prototype.toLowerCase.call(b);return"finite"==b?isFinite(a):"array"==b&&(a instanceof Array||Array.isArray&&Array.isArray(a))?!0:"null"==b&&null===a||b==typeof a&&null!==a||"object"==b&&a===Object(a)||Object.prototype.toString.call(a).slice(8,-1).toLowerCase()==b},format_str:function(){var a=/\{([^\}]+)\}/g,b=/(?:(?:^|\.)(.+?)(?=\[|\.|$|\()|\[('|")(.+?)\2\])(\(\))?/g,c=function(d,e,g){var f=g;e.replace(b,function(l,n,q,r,p){n=n||r;f&&(n in f&&(f=f[n]),"function"==
typeof f&&p&&(f=f()))});return f=(null==f||f==g?d:f)+""};return function(d,e){return String(d).replace(a,function(g,f){return c(g,f,e)})}}()},Browser={versions:function(){var a=navigator.userAgent;return{trident:-1<a.indexOf("Trident"),presto:-1<a.indexOf("Presto"),webKit:-1<a.indexOf("AppleWebKit"),gecko:-1<a.indexOf("Gecko")&&-1==a.indexOf("KHTML"),mobile:!!a.match(/AppleWebKit.*Mobile.*/),ios:!!a.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/),android:-1<a.indexOf("Android")||-1<a.indexOf("Linux"),iPhone:-1<
a.indexOf("iPhone"),iPad:-1<a.indexOf("iPad"),webApp:-1==a.indexOf("Safari")}}(),language:(navigator.browserLanguage||navigator.language).toLowerCase()};Element.prototype.attr=function(a,b){if(!a){if(1!=this.nodeType)return{text:this.nodeValue};for(var c=this.attributes,d={},e=0,g=c.length;e<g;e++)d[c[e].nodeName]=c[e].nodeValue;return d}if(Util.is(a,"string"))if(1<arguments.length)c={},c[a]=b,a=c;else return this.getAttribute(a);for(d in a)a.hasOwnProperty(d)&&this.setAttribute(d,a[d]);return this};
...
Element.prototype.updateStyle=function(a,b){var c=this.getAttribute("style"),d=!1,e="";if(null!=c&&0<c.trim().length){c=c.split(";");for(var g=0;g<c.length&&0<c[g].trim().length;g++){var f=c[g].split(":");2==f.length&&(a==f[0].trim()?(d=!0,null!=b&&(e+=a+": "+b+"; ")):e+=f[0].trim()+": "+f[1].trim()+"; ")}}d||(e+=a+": "+b+"; ");this.setAttribute("style",e)};Array.prototype.each=function(a,b){b=this.findItem(b);for(var c=0;c<b.length;c++)"function"==typeof a&&a.call(b[c])};
...
Frame.prototype={startAnimation:function(a,b,c,d){var e=this;this.stopAnimation();c<Config.WorldMap.minScale?c=Config.WorldMap.minScale:c>Config.WorldMap.maxScale&&(c=Config.WorldMap.maxScale);var g=this.width/2-a*c,f=this.height/2-b*c,l=Date.now(),n=this.map.left,q=this.map.top,r=this.map.scale,p=function(){var m=Date.now()-l;m=Math.min(m/1200,1);var k=1-Math.pow(1-m,3),t=q+(f-q)*k,u=r+(c-r)*k;e.map.left=n+(g-n)*k;e.map.top=t;e.map.scale=u;e.map.updateTransform();1<=m?(e.map.left=g,e.map.top=f,e.map.scale=
...
var g=Util.getUrlHash("cx"),f=Util.getUrlHash("cy"),l=Util.getUrlHash("s");null!=g&&null!=f?(g=parseFloat(g),f=parseFloat(f),l=null!=l?parseFloat(l):c.map.scale,c.map.scale=l,c.map.moveTo(c.width/2-g*l,c.height/2-f*l),c.map.updateTransform()):c.setCenterPoint(c.map.width/2,c.map.height/2,!1,null);c.updateStatusLabel();l=Util.getUrlHash("r");g=Util.getUrlHash("f");0==l&&c.toolbar.showRoutes(!1);0==g&&c.toolbar.showFlights(!1);"function"==typeof b&&b()});this.toolbar.onZoom=function(g){var f=c.convertFramePointToMap(c.width/
2,c.height/2);return c.map.zoom(g,f)};this.toolbar.onZoomRestore=function(){c.scaleMapTo(1,null)};this.toolbar.onNavigate=function(g,f){c.map.move(g,f)};this.toolbar.onNaviRestore=function(){c.setCenterPoint(c.map.width/2,c.map.height/2,!0,null)};this.map.onScaleChanged=function(){c.updateStatusLabel()};this.map.onPositionChanged=function(){c.updateStatusLabel()};if(this.fullscreen){var e=function(){c.map.resize(c.width,c.height);c.toolbar.adjustPosition(c.width,c.height)};setInterval(function(g){g=
document.documentElement.clientWidth;var f=document.documentElement.clientHeight;if(g!=c.width||f!=c.height)c.width=g,c.height=f,c.frameObj.style.width=c.width+"px",c.frameObj.style.height=c.height+"px",e()},200);e()}else this.toolbar.adjustPosition(this.width,this.height)},updateStatusLabel:function(){this.statusLabel.textContent="[{0}, {1}] x {2}".format(this.map.left.toFixed(1),this.map.top.toFixed(1),this.map.scale.toFixed(1));var a=this.getCenterPoint();Util.setUrlHash("cx",a.cx.toFixed(3));
...
this,c=a.keyCode;switch(a.type){case "keydown":var d=function(){var e=Config.keyboard.changeUnit,g=0,f=0;0<(b.arrowKeyStatus&1)&&(g+=e);0<(b.arrowKeyStatus&2)&&(f+=e);0<(b.arrowKeyStatus&4)&&(g-=e);0<(b.arrowKeyStatus&8)&&(f-=e);0<b.arrowKeyStatus?(b.map.move(g,f),b.keyboardTimer=setTimeout(d,Config.keyboard.timerDelay)):b.keyboardTimer=null};switch(c){case 37:case 65:this.arrowKeyStatus|=1;break;case 38:case 87:this.arrowKeyStatus|=2;break;case 39:case 68:this.arrowKeyStatus|=4;break;case 40:case 83:this.arrowKeyStatus|=
...
var e=function(){d.frame.moveMapTo(d.left+c*d.scale,d.top,null)};a.addEventListener("mousedown",function(){e()},!1);a.addEventListener("touchstart",function(){e()},!1)},renderPois:function(a){var b=this;window.mapdata.pois.forEach(function(c){b.renderPoi(a,c,0);b._renderGhostPois(a,c)})},renderPoi:function(a,b,c){var d=b.label,e=b.level,g=b.key,f=this.parseLatLon(b.latlon);b=f.x;f=f.y;null!=c&&0!=c&&(b+=c);a.createChildNS("circle",{cx:b,cy:f,r:0,fill:"#E66C0F",stroke:"none",class:"poi-circle","data-poi-key":g});
a.createChildNS("text",{x:b,y:f,fill:"#000000",stroke:"none","font-size":1/this.scale*12,class:"poi-label",style:"display: none","data-level":e,"data-poi-key":g},d)},getControlPoint:function(a,b,c,d){var e=(a.x+b.x)/2;b=(a.y+b.y)/2;var g=Math.sqrt(Math.pow(a.x-e,2)+Math.pow(a.y-b,2));c*=g;var f={x:(a.y-b)*c/g+e,y:(e-a.x)*c/g+b};a={x:(b-a.y)*c/g+e,y:(a.x-e)*c/g+b};return 0<Math.atan2(f.y-b,f.x-e)*d?f:a},drawFlightLine:function(a,b,c,d){0==d?(this.drawFlightLine(a,b,c,-1),this.drawFlightLine(a,b,c,
...
this.moveTo(this.left+a,this.top+b,null);return!0},moveTo:function(a,b){this.left=a;this.top=b;this.updateTransform();if("function"==typeof this.onPositionChanged)this.onPositionChanged()},showFlights:function(a){this._flightPaths||(this._flightPaths=this.mapGroup.querySelectorAll("path.flight"));var b=this._flightPaths;requestAnimationFrame(function(){for(var c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")})},filterByYears:function(a){if(a&&0!==a.length){this._clearAllElements();this._clearElementCache();
var b=this._filterFlightsByYears(a);this._renderFilteredFlights(b);this._renderFilteredRoutes(a);this._renderFilteredPois(a);this.updateTransform()}else this._clearAllElements(),this._clearElementCache(),this._flightPaths=null},_filterFlightsByYears:function(a){var b=[];window.mapdata.flights.forEach(function(c){var d=[];c.forEach(function(e){e.year&&-1!==a.indexOf(e.year)&&d.push(e)});0<d.length&&b.push(d)});return b},_renderFilteredPois:function(a){var b=this;window.mapdata.pois.forEach(function(c){b._shouldShowPoiForYears(c,
a)&&(b.renderPoi(b.mapGroup,c,0),b._renderGhostPois(b.mapGroup,c))})},_shouldShowPoiForYears:function(a,b){if(!a.year)return!1;a=this._parseYears(a.year);for(var c=0;c<a.length;c++)if(-1!==b.indexOf(a[c]))return!0;return!1},_parseYears:function(a){return"string"===typeof a?-1<a.indexOf(",")?a.split(",").map(function(b){return parseInt(b.trim())}):[parseInt(a)]:[a]},showRoutes:function(a){this._routePaths||(this._routePaths=this.mapGroup.querySelectorAll("path.route"));var b=this._routePaths;requestAnimationFrame(function(){for(var c=
0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")})},showPois:function(a){this._poiElements||(this._poiElements=this.mapGroup.querySelectorAll("circle.poi-circle, text.poi-label"));var b=this._poiElements;requestAnimationFrame(function(){for(var c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")})},restoreOriginalRendering:function(){this._clearAllElements();Config.colorIndex=0;this.renderFlightsAndRoutes(this.mapGroup);this.renderPois(this.mapGroup);this._applyCurrentToggleStates();
this.updateTransform()},getPoi:function(a){for(var b=0;b<window.mapdata.pois.length;b++)if(window.mapdata.pois[b].key==a)return window.mapdata.pois[b];return null},getPoiPosition:function(a){a=this.getPoi(a);return null!=a?this.parseLatLon(a.latlon):{x:0,y:0}},getXY:function(a,b){return{x:2.6938*b+465.4,y:-2.6938*a+227.066}},getLatLon:function(a,b){return{lat:(b-227.066)/-2.6938,lon:(a-465.4)/2.6938}},parseLatLon:function(a){var b=(a=String(a).split(/(\d+(?:\.\d+)?)[\xb0\s]?\s*(?:(\d+(?:\.\d+)?)['\u2019\u2032\s])?\s*(?:(\d+(?:\.\d+)?)["\u201d\u2033\s])?\s*([SNEW])?/i))&&
...
a?this.frame.toolbar.flightOverlay:this.frame.toolbar.routesOverlay;return!a||"none"!==a.attr("stroke")},_updatePoiCircles:function(a){for(var b=this.mapGroup.querySelectorAll("circle.poi-circle"),c=this.mapGroup.querySelectorAll("text.poi-label"),d={},e=0;e<c.length;e++){var g=c[e],f=g.attr("data-poi-key");g=g.attr("data-level");g=Util.isNull(g)?0:parseFloat(g);d[f]=!a&&this.scale>=g}for(a=0;a<b.length;a++)c=b[a],f=c.attr("data-poi-key"),d[f]?(f=1/this.scale*4,1>this.scale&&(f/=2),c.attr("r",f),
c.attr("fill","#E66C0F")):(f=1/this.scale*1.5,1>this.scale&&(f/=2),c.attr("r",f),c.attr("fill","#999999"))},_updatePoiLabels:function(a){for(var b=this.mapGroup.querySelectorAll("text.poi-label"),c=0;c<b.length;c++){var d=b[c],e=d.attr("data-level");Util.isNull(e)&&(e=0);a?"none"!==d.getStyle("display")&&d.updateStyle("display","none"):this.scale>=e?("none"===d.getStyle("display")&&d.updateStyle("display",""),d.attr("font-size",1/this.scale*12)):"none"!==d.getStyle("display")&&d.updateStyle("display",
"none")}},_renderFilteredFlights:function(a){if(this._isToggleEnabled("flight")){var b=this;Config.colorIndex=0;a.forEach(function(c){c.forEach(function(d){b.renderFlight(b.mapGroup,d.from,d.to,d.crossPacific,d.direction)});Config.colorIndex++})}},_renderFilteredRoutes:function(a){if(this._isToggleEnabled("routes")){var b=this;window.mapdata.routes.forEach(function(c){c.year&&-1!==a.indexOf(c.year)&&b.renderRouteGroup(b.mapGroup,c.path)})}},_applyCurrentToggleStates:function(){this.frame&&this.frame.toolbar&&
(this._isToggleEnabled("flight")||this.showFlights(!1),this._isToggleEnabled("routes")||this.showRoutes(!1))}};function Toolbar(a){this.frame=a;this.zoomRatio=1;this.naviSpeed={x:0,y:0};this.buttonCount=0;this.yearFilter=this.flightOverlay=this.routesOverlay=this.onNaviRestore=this.onNavigate=this.onZoomRestore=this.onZoom=this.onZoomOut=this.onZoomIn=this.naviGroup=this.toolSub=this.toolGroup=this.scaleGroup=this.naviTimer=this.zoomTimer=null;this.selectedYears=[];this.filterCollapsed=!1}
...
2*Config.Toolbar.buttonPadding)/2,iconSize:Config.Toolbar.buttonSize-2*Config.Toolbar.buttonPadding});this.renderButton(this.scaleGroup,1,0,c,!0,!1,!1,function(d){b.zoomRatio=.9;b.startZoomTimer()},function(d){b.zoomRatio=1});this.toolGroup=a.createChildNS("g");this.renderButton(this.toolGroup,0,0,"M8,0 L24,16 L8,32",!0,!1,!1,function(d,e,g){null==b.toolSub.getStyle("display")?(b.toolSub.updateStyle("display","none"),e.attr("d","M8,0 L24,16 L8,32")):(b.toolSub.updateStyle("display",null),e.attr("d",
...
!1,!0,!0,function(d,e,g){b.showFlights("none"==g.attr("stroke"))},null).overlay;this.routesOverlay=this.renderButton(this.toolSub,0,3,"M13.671,13.059c-0.588-1.381-1.096-2.574-0.763-4.564c0.606-3.606,6.876-7.688,13.74-7.338l0.059-1.135c-7.559-0.377-14.231,4.142-14.926,8.287c-0.389,2.315,0.234,3.778,0.837,5.193c0.455,1.066,0.924,2.168,1,3.723c0.12,2.441-7.298,6.35-12.002,8.242l0.429,1.053c1.322-0.531,12.915-5.309,12.717-9.352C14.675,15.414,14.142,14.163,13.671,13.059z M30.352,21.012c-0.238-3.152-1.9-6.189-4.211-7.736C22.1,10.57,21.781,9.129,22.635,7.68c1.965-3.333,7.047-3.382,7.047-3.382V3.162c0,0-5.736,0.045-8.035,3.945c-1.691,2.871,0.908,5.115,3.891,7.112c2.031,1.36,3.48,4.059,3.691,6.877c0.188,2.496-0.465,6.27-4.633,10.066L25.369,32C29.875,27.895,30.557,23.758,30.352,21.012z M14.12,28.92l0.267,1.105c0.025-0.006,0.618-0.148,1.446-0.527l-0.479-1.033C14.637,28.795,14.125,28.918,14.12,28.92z M17.918,13.655c0.461,0.811,0.945,1.683,1.348,2.64l1.057-0.437c-0.428-1.016-0.93-1.92-1.406-2.761L17.918,13.655z M17.545,7.968L16.5,7.505c-0.235,0.527-0.351,1.054-0.351,1.613c0,0.551,0.113,1.125,0.35,1.76l1.073-0.394c-0.188-0.505-0.279-0.952-0.279-1.366C17.293,8.722,17.377,8.346,17.545,7.968zM17.73,26.896l0.779,0.83c0.813-0.75,1.461-1.619,1.932-2.584l-1.029-0.496C19.004,25.484,18.438,26.242,17.73,26.896zM21.209,18.885l-1.129,0.182c0.055,0.342,0.096,0.689,0.119,1.033c0.018,0.266,0.027,0.523,0.027,0.775c0,0.359-0.018,0.717-0.055,1.059l1.139,0.119c0.039-0.383,0.061-0.779,0.061-1.178c0-0.275-0.01-0.559-0.031-0.852C21.314,19.645,21.27,19.26,21.209,18.885z M19.818,4.114c-0.438,0.293-0.84,0.587-1.193,0.874l0.723,0.881c0.326-0.265,0.701-0.539,1.109-0.813L19.818,4.114z",
!1,!0,!0,function(d,e,g){b.showRoutes("none"==g.attr("stroke"))},null).overlay;this.renderButton(this.toolSub,1,0,"M16,0 L32,16 H28 V32 H20 V20 H12 V32 H4 V16 H0 Z",!0,!1,!1,function(d){b.frame.home()},null);this.naviGroup=a.createChildNS("g");this.renderButton(this.naviGroup,1,0,"M8,16 L20,24 V8 Z",!0,!1,!1,function(d){b.naviSpeed.x=Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.x=0});this.renderButton(this.naviGroup,0,1,"M16,8 L8,20 H24 Z",!0,!1,!1,function(d){b.naviSpeed.y=
Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.y=0});this.renderButton(this.naviGroup,1,2,"M24,16 L12,8 V24 Z",!0,!1,!1,function(d){b.naviSpeed.x=-Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.x=0});this.renderButton(this.naviGroup,1,1,"M16,24 L24,12 H8 Z",!0,!1,!1,function(d){b.naviSpeed.y=-Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.y=0});this.initYearFilter()},renderCustomButton:function(a,b,c,d){if(this.toolSub){var e=this,g=++this.buttonCount;
this.renderButton(this.toolSub,1,g,a,!0,!1,!1,function(f){e.frame.startAnimation(b,c,d)},null)}},showRoutes:function(a){this.frame.map.showRoutes(a);this.routesOverlay.attr("stroke",a?"#333":"none");Util.setUrlHash("r",a?1:0)},showFlights:function(a){this.frame.map.showFlights(a);this.flightOverlay.attr("stroke",a?"#333":"none");Util.setUrlHash("f",a?1:0)},showPois:function(a){this.frame.map.showPois(a)},getUniqueFlightYears:function(){var a=[];window.mapdata.flights.forEach(function(b){b.forEach(function(c){c.year&&
1900<c.year&&-1===a.indexOf(c.year)&&a.push(c.year)})});window.mapdata.pois.forEach(function(b){if(b.year){var c=[];c="string"===typeof b.year?-1<b.year.indexOf(",")?b.year.split(",").map(function(d){return parseInt(d.trim())}):[parseInt(b.year)]:[b.year];c.forEach(function(d){1900<d&&-1===a.indexOf(d)&&a.push(d)})}});window.mapdata.routes.forEach(function(b){b.year&&1900<b.year&&-1===a.indexOf(b.year)&&a.push(b.year)});return a.sort()},initYearFilter:function(){var a=this.getUniqueFlightYears();
this.selectedYears=a.slice();var b=Util.getUrlHash("years"),c=!1;if(b)if(c=!0,"none"===b)this.selectedYears=[];else try{this.selectedYears=b.split(",").map(function(d){d=parseInt(d.trim(),10);return 1900<=d&&2100>=d?d:null}).filter(function(d){return null!==d&&-1!==a.indexOf(d)})}catch(d){this.selectedYears=a.slice()}this.renderYearFilter();c||this.selectedYears.length!==a.length?this.applyYearFilter():this.frame.map.filterByYears(this.selectedYears)},renderYearFilter:function(){var a=this.getUniqueFlightYears();
0===a.length||this.yearFilter||(this.yearFilter=this.frame.map.getExtraGroup().createChildNS("g",{id:"year-filter-group",class:"year-filter-svg"}),this._createYearFilterBackground(a),this._createYearCheckboxes(a),this.positionYearFilter())},_createYearFilterBackground:function(a){a=this._getFilterDimensions(a);this.yearFilter.createChildNS("rect",{x:2,y:2,width:a.width,height:a.height,fill:"rgba(0, 0, 0, 0.1)",rx:6,ry:6});this.yearFilter.createChildNS("rect",{x:0,y:0,width:a.width,height:a.height,
fill:"rgba(255, 255, 255, 0.97)",stroke:"#bbb","stroke-width":1,rx:6,ry:6})},_createYearCheckboxes:function(a){var b=this,c=8;this._createFilterTitleBar(8,c);c+=24;c+=8;c+=10;this.filterCollapsed||(this.createSVGCheckbox(this.yearFilter,13,c,"All Years",this.selectedYears.length===a.length,function(){b._toggleAllYears(a)}),c+=24,a.forEach(function(d){b.createSVGCheckbox(b.yearFilter,13,c,d.toString(),-1!==b.selectedYears.indexOf(d),function(){b._toggleYear(d)});c+=22}),this._addVersionNumber(a))},
_getFilterDimensions:function(a){var b=Math.max.apply(Math,a.concat(["All Years","Years"]).map(function(c){return 9*c.toString().length}));return{width:Math.max(140,32+b+16+8),height:this.filterCollapsed?40:22*a.length+98}},_createFilterTitleBar:function(a,b){var c=this,d=this.getUniqueFlightYears();d=Math.max.apply(Math,d.concat(["All Years","Years"]).map(function(g){return 9*g.toString().length}));var e=Math.max(140,32+d+16+8);d=this.yearFilter.createChildNS("rect",{x:0,y:b,width:e,height:24,fill:"rgba(240, 240, 240, 0.3)",
stroke:"none",rx:4,ry:4,style:"cursor: pointer;"});this.yearFilter.createChildNS("text",{x:a+4,y:b+15,fill:"#333","font-size":"12px","font-family":"Arial, sans-serif","font-weight":"bold"},"Years");a=e-26;e=b+0;b=this.yearFilter.createChildNS("rect",{x:a-6,y:e,width:24,height:24,fill:"transparent",stroke:"none",style:"cursor: pointer;"});a=this.yearFilter.createChildNS("path",{d:this.filterCollapsed?"M3,2 L9,6 L3,10 Z":"M2,3 L6,9 L10,3 Z",fill:"#666",stroke:"none",transform:"translate("+a+", "+(e+
6)+")",style:"cursor: pointer;"});e=function(g){g.addEventListener("click",function(f){f.preventDefault();f.stopPropagation();c._toggleFilterCollapse()});g.addEventListener("touchstart",function(f){f.preventDefault();f.stopPropagation();f._handled=!0});g.addEventListener("touchend",function(f){f.preventDefault();f.stopPropagation();f._handled=!0;c._toggleFilterCollapse()})};e(d);e(b);e(a)},_addVersionNumber:function(a){if(!this.filterCollapsed){a=22*a.length+86;var b=this.yearFilter.querySelector("rect:nth-child(2)");
b=b?parseInt(b.getAttribute("width"))/2:70;this.yearFilter.createChildNS("text",{x:b,y:a,fill:"#999","font-size":"9px","font-family":"Arial, sans-serif","text-anchor":"middle","font-style":"italic"},"v"+Config.version)}},_toggleFilterCollapse:function(){this.filterCollapsed=!this.filterCollapsed;this._refreshYearFilter()},_refreshYearFilter:function(){var a=null;this.yearFilter&&(a=this.yearFilter.getAttribute("transform"),this.yearFilter.parentNode.removeChild(this.yearFilter),this.yearFilter=null);
this.renderYearFilter();a&&this.yearFilter&&this.yearFilter.setAttribute("transform",a)},_toggleAllYears:function(a){this.selectedYears=this.selectedYears.length===a.length?[]:a.slice();this.updateSVGCheckboxes();this.applyYearFilter()},_toggleYear:function(a){var b=this.selectedYears.indexOf(a);-1!==b?this.selectedYears.splice(b,1):this.selectedYears.push(a);this.selectedYears.sort();this.updateSVGCheckboxes();this.applyYearFilter()},positionYearFilter:function(a,b){this.yearFilter&&(a=a||(this.frame&&
this.frame.map?this.frame.map.width:1E3),b=this.yearFilter.querySelectorAll("rect"),b=1<b.length?parseInt(b[1].getAttribute("width")):130,this.yearFilter.attr("transform","translate("+(a-b-15)+", 15)"))},createSVGCheckbox:function(a,b,c,d,e,g){a=a.createChildNS("g",{class:"svg-checkbox","data-label":d});b=this._createCheckboxElements(a,b,c,16,d,e);this._addCheckboxEventHandlers(b.bg,b.text,b.touchArea,g);a.checkmarkElement=b.checkmark;a.isChecked=e;return a},_createCheckboxElements:function(a,b,c,
d,e,g){var f=a.createChildNS("rect",{x:b-8,y:c-d-4,width:d+8+(8*e.toString().length+10)+20,height:28,fill:"transparent",stroke:"none",style:"cursor: pointer"}),l=a.createChildNS("rect",{x:b,y:c-d+2,width:d,height:d,fill:"white",stroke:"#666","stroke-width":1,rx:3,ry:3,style:"cursor: pointer"});g=a.createChildNS("path",{d:"M"+(b+3)+","+(c-6)+" L"+(b+7)+","+(c-2)+" L"+(b+13)+","+(c-10),stroke:"#2c5aa0","stroke-width":2.5,fill:"none","stroke-linecap":"round","stroke-linejoin":"round",style:g?"display: block":
"display: none"});a=a.createChildNS("text",{x:b+d+8,y:c,fill:"#333","font-size":"13px","font-family":"Arial, sans-serif",style:"cursor: pointer"},e);return{bg:l,checkmark:g,text:a,touchArea:f}},_addCheckboxEventHandlers:function(a,b,c,d){var e=0,g=a.attr("fill"),f=null,l=!1,n=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;f={x:h.clientX,y:h.clientY};l=!1;a.attr("fill","#e6f3ff")},q=function(h){f&&5<Math.abs(h.clientX-f.x)+Math.abs(h.clientY-f.y)&&(l=!0,a.attr("fill",g))},r=function(h){h.preventDefault();
h.stopPropagation();h._handled=!0;f&&!l&&d();f=null;l=!1;a.attr("fill",g)},p=function(h){!f&&300<Date.now()-e&&a.attr("fill","#f0f0f0")},m=function(h){f?(f=null,l=!1,a.attr("fill",g)):300<Date.now()-e&&a.attr("fill",g)},k=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();a.attr("fill","#e6f3ff")},t=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();a.attr("fill",g);d()},u=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();
a.attr("fill",g)},v=function(h){h.preventDefault();h.stopPropagation();h._handled=!0};[a,b,c].forEach(function(h){h.addEventListener("mousedown",n);h.addEventListener("mousemove",q);h.addEventListener("mouseup",r);h.addEventListener("mouseenter",p);h.addEventListener("mouseleave",m);h.addEventListener("touchstart",k,{passive:!1});h.addEventListener("touchend",t,{passive:!1});h.addEventListener("touchcancel",u,{passive:!1});h.addEventListener("touchmove",v,{passive:!1})})},updateSVGCheckboxes:function(){if(this.yearFilter)for(var a=
this.getUniqueFlightYears(),b=this.yearFilter.querySelectorAll("g.svg-checkbox"),c=0;c<b.length;c++){var d=b[c],e=d.getAttribute("data-label");e="All Years"===e?this.selectedYears.length===a.length:-1!==this.selectedYears.indexOf(parseInt(e));d.isChecked=e;d.checkmarkElement&&(d.checkmarkElement.style.display=e?"block":"none")}},updateYearCheckboxes:function(){this.updateSVGCheckboxes()},updateAllCheckbox:function(){this.updateSVGCheckboxes()},applyYearFilter:function(){this.frame.map.filterByYears(this.selectedYears);
var a=this.getUniqueFlightYears();a=0===this.selectedYears.length?"none":this.selectedYears.length===a.length?"":this.selectedYears.join(",");Util.setUrlHash("years",a)},adjustPosition:function(a,b){this.scaleGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:a-Config.Toolbar.marginRight-Config.Toolbar.buttonSize,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}));this.toolGroup.attr("transform",Util.format_str("translate({left}, {top})",
{left:Config.Toolbar.marginLeft,top:Config.Toolbar.marginTop}));this.naviGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:Config.Toolbar.marginLeft,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}));this.positionYearFilter(a,b)},renderButton:function(a,b,c,d,e,g,f,l,n){var q=this,r=0;a=a.createChildNS("g",{transform:"translate({0}, {1})".format((Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)*c,(Config.Toolbar.buttonSize+
Config.Toolbar.buttonSpacing)*b)});var p=a.createChildNS("path",{fill:g?"RGBA(0,0,0,1)":"none",stroke:e?"RGBA(0,0,0,1)":"none","stroke-width":4,"stroke-linejoin":"round",d:d,transform:"translate({0}, {0})".format(Config.Toolbar.buttonPadding)}),m=a.createChildNS("rect",{fill:"RGBA(255,255,255,0.4)",stroke:f?"#333":"none","stroke-width":1,x:0,y:0,rx:Config.Toolbar.buttonSize/8,ry:Config.Toolbar.buttonSize/8,width:Config.Toolbar.buttonSize,height:Config.Toolbar.buttonSize});m.addEventListener("touchstart",
function(k){k.preventDefault();k.stopPropagation();k._handled=!0;r=Date.now();q.highlightIcon(this.parentNode.childNodes[0],!0);"function"===typeof l&&l(k,p,m)},!0);m.addEventListener("touchend",function(k){k.preventDefault();k.stopPropagation();k._handled=!0;r=Date.now();q.highlightIcon(this.parentNode.childNodes[0],!1);"function"===typeof n&&n(k,p,m)},!0);m.addEventListener("touchcancel",function(k){k.preventDefault();k.stopPropagation();k._handled=!0;r=Date.now();q.highlightIcon(this.parentNode.childNodes[0],
!1);"function"===typeof n&&n(k,p,m)},!0);m.addEventListener("touchmove",function(k){k.preventDefault();k.stopPropagation();k._handled=!0},!0);m.addEventListener("mousedown",function(k){500>Date.now()-r||(q.highlightIcon(this.parentNode.childNodes[0],!0),"function"===typeof l&&l(k,p,m),k.stopPropagation())},!0);m.addEventListener("mouseup",function(k){500>Date.now()-r||(q.highlightIcon(this.parentNode.childNodes[0],!1),"function"===typeof n&&n(k,p,m),k.stopPropagation())},!0);m.addEventListener("mouseout",
function(k){500>Date.now()-r||(q.highlightIcon(this.parentNode.childNodes[0],!1),"function"===typeof n&&n(k,p,m),k.stopPropagation())},!0);m.addEventListener("mousemove",function(k){k.stopPropagation()},!0);return{icon:p,overlay:m}},startZoomTimer:function(){var a=this;this.zoomTimer&&(clearTimeout(this.zoomTimer),this.zoomTimer=null);var b=function(){1!==a.zoomRatio&&"function"===typeof a.onZoom?(requestAnimationFrame(function(){a.onZoom(a.zoomRatio)}),a.zoomTimer=setTimeout(b,Config.Toolbar.zoomTimerDelay)):
