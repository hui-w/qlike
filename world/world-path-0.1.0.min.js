...
/\{([^\}]+)\}/g,b=/(?:(?:^|\.)(.+?)(?=\[|\.|$|\()|\[('|")(.+?)\2\])(\(\))?/g,c=function(d,e,f){var g=f;e.replace(b,function(l,n,q,r,p){n=n||r;g&&(n in g&&(g=g[n]),"function"==typeof g&&p&&(g=g()))});return g=(null==g||g==f?d:g)+""};return function(d,e){return String(d).replace(a,function(f,g){return c(f,g,e)})}}()},Browser={versions:function(){var a=navigator.userAgent;return{trident:-1<a.indexOf("Trident"),presto:-1<a.indexOf("Presto"),webKit:-1<a.indexOf("AppleWebKit"),gecko:-1<a.indexOf("Gecko")&&
...
Frame.prototype={startAnimation:function(a,b,c,d){var e=this;this.stopAnimation();c<Config.WorldMap.minScale?c=Config.WorldMap.minScale:c>Config.WorldMap.maxScale&&(c=Config.WorldMap.maxScale);var f=this.width/2-a*c,g=this.height/2-b*c,l=Date.now(),n=this.map.left,q=this.map.top,r=this.map.scale,p=function(){var m=Date.now()-l;m=Math.min(m/1200,1);var k=1-Math.pow(1-m,3),t=q+(g-q)*k,u=r+(c-r)*k;e.map.left=n+(f-n)*k;e.map.top=t;e.map.scale=u;e.map.updateTransform();1<=m?(e.map.left=f,e.map.top=g,e.map.scale=
c,e.map.updateTransform(),e.currentAnimation=null,e.inMotion=!1,"function"==typeof d&&d()):e.currentAnimation=requestAnimationFrame(p)};this.inMotion=!0;this.currentAnimation=requestAnimationFrame(p)},stopAnimation:function(){this.currentAnimation&&(cancelAnimationFrame(this.currentAnimation),this.currentAnimation=null,this.inMotion=!1)},setCenterAndScale:function(a,b,c,d){this.startAnimation(a,b,c,d)},setCenterPoint:function(a,b,c,d){c?this.startAnimation(a,b,this.map.scale,d):(this.map.moveTo(this.width/
2-a*this.map.scale,this.height/2-b*this.map.scale),"function"==typeof d&&d())},scaleMapTo:function(a,b){var c=this.getCenterPoint();this.startAnimation(c.cx,c.cy,a,b)},moveMapTo:function(a,b,c){this.startAnimation((this.width/2-a)/this.map.scale,(this.height/2-b)/this.map.scale,this.map.scale,c)},getCenterPoint:function(){return{cx:(this.width/2-this.map.left)/this.map.scale,cy:(this.height/2-this.map.top)/this.map.scale}},renderInto:function(a,b){var c=this;this.frameObj=document.createElement("div");
var d=Util.format_str("width: {width}px; height: {height}px; cursor: pointer; overflow: hidden; border: none; background-color: RGBA(100, 100, 100, 0.2);",{width:this.width,height:this.height});this.frameObj.setAttribute("style",d);a.appendChild(this.frameObj);this.toolbar=new Toolbar(this);this.map.renderInto(this.frameObj,function(){c.enableInteractive();c.toolbar.renderInto(c.map.getExtraGroup());c.statusLabel=c.map.getExtraGroup().createChildNS("text",{fill:"#666",class:"no-select",x:4,y:10,"font-size":8});
var f=Util.getUrlHash("cx"),g=Util.getUrlHash("cy"),l=Util.getUrlHash("s");null!=f&&null!=g?(f=parseFloat(f),g=parseFloat(g),l=null!=l?parseFloat(l):c.map.scale,c.map.scale=l,c.map.moveTo(c.width/2-f*l,c.height/2-g*l),c.map.updateTransform()):c.setCenterPoint(c.map.width/2,c.map.height/2,!1,null);c.updateStatusLabel();l=Util.getUrlHash("r");f=Util.getUrlHash("f");0==l&&c.toolbar.showRoutes(!1);0==f&&c.toolbar.showFlights(!1);"function"==typeof b&&b()});this.toolbar.onZoom=function(f){var g=c.convertFramePointToMap(c.width/
2,c.height/2);return c.map.zoom(f,g)};this.toolbar.onZoomRestore=function(){c.scaleMapTo(1,null)};this.toolbar.onNavigate=function(f,g){c.map.move(f,g)};this.toolbar.onNaviRestore=function(){c.setCenterPoint(c.map.width/2,c.map.height/2,!0,null)};this.map.onScaleChanged=function(){c.updateStatusLabel()};this.map.onPositionChanged=function(){c.updateStatusLabel()};if(this.fullscreen){var e=function(){c.map.resize(c.width,c.height);c.toolbar.adjustPosition(c.width,c.height)};setInterval(function(f){f=
document.documentElement.clientWidth;var g=document.documentElement.clientHeight;if(f!=c.width||g!=c.height)c.width=f,c.height=g,c.frameObj.style.width=c.width+"px",c.frameObj.style.height=c.height+"px",e()},200);e()}else this.toolbar.adjustPosition(this.width,this.height)},updateStatusLabel:function(){this.statusLabel.textContent="[{0}, {1}] x {2}".format(this.map.left.toFixed(1),this.map.top.toFixed(1),this.map.scale.toFixed(1));var a=this.getCenterPoint();Util.setUrlHash("cx",a.cx.toFixed(3));
Util.setUrlHash("cy",a.cy.toFixed(3));Util.setUrlHash("s",this.map.scale.toFixed(3))},enableInteractive:function(){var a=this;this.handleTouchEvent=function(c){if(!c._handled)switch(c.preventDefault(),c.type){case "touchstart":a._onTouchStart(c);break;case "touchmove":a._onTouchMove(c);break;case "touchend":a._onTouchEnd(c);break;case "touchcancel":a._onTouchCancel(c)}};var b={passive:!1};this.frameObj.addEventListener("touchstart",this.handleTouchEvent,b);this.frameObj.addEventListener("touchmove",
this.handleTouchEvent,b);this.frameObj.addEventListener("touchend",this.handleTouchEvent,b);this.frameObj.addEventListener("touchcancel",this.handleTouchEvent,b);this.handleMouseEvent=function(c){if(!a.inMotion)switch(c.preventDefault(),c.type){case "mousedown":a.eventDown(c);break;case "mousemove":a.eventMove(c);break;case "mouseup":a.eventUp(c);break;case "mouseleave":a.isHolding=!1;a.inMotion=!1;a._stopDragging();break;case "mousewheel":var d=a.getEventPositionOnMap(c);d&&a.map.zoom(0<c.wheelDelta?
1.1:.9,d)}};this.frameObj.addEventListener("mousedown",this.handleMouseEvent,!1);this.frameObj.addEventListener("mousemove",this.handleMouseEvent,!1);this.frameObj.addEventListener("mouseup",this.handleMouseEvent,!1);this.frameObj.addEventListener("mouseleave",this.handleMouseEvent,!1);this.frameObj.addEventListener("dblclick",this.handleMouseEvent,!1);this.frameObj.addEventListener("mousewheel",this.handleMouseEvent,!1);this.handleKeyEvent=function(c){a.inMotion||a.handleKey(c,a)};document.addEventListener("keydown",
this.handleKeyEvent,!1);document.addEventListener("keyup",this.handleKeyEvent,!1)},eventDown:function(a){!a._handled&&(this.isHolding=!0,a.type&&0===a.type.indexOf("mouse")&&this._startDragging(),a=this.getEventCoordinates(a))&&(this.mousePoint.x=a.x,this.mousePoint.y=a.y)},eventUp:function(a){this.isHolding=!1;this._stopDragging()},eventMove:function(a){!a._handled&&this.isHolding&&(a.type&&0===a.type.indexOf("touch")&&this._startDragging(),a=this.getEventCoordinates(a))&&(this.map.move(a.x-this.mousePoint.x,
a.y-this.mousePoint.y),this.mousePoint.x=a.x,this.mousePoint.y=a.y)},_onTouchStart:function(a){this.stopAnimation();a=a.touches;1===a.length?this._startSingleTouch(a[0]):2===a.length&&this._startPinchZoom(a[0],a[1])},_onTouchMove:function(a){a=a.touches;1===a.length&&"pan"===this.touchState?this._continueSingleTouch(a[0]):2===a.length&&"zoom"===this.touchState&&this._continuePinchZoom(a[0],a[1])},_onTouchEnd:function(a){a=a.touches;0===a.length?this._endTouch():1===a.length&&"zoom"===this.touchState&&
(this.touchState="pan",this.startScale=this.startDistance=null,this._startSingleTouch(a[0]))},_onTouchCancel:function(a){this._endTouch()},_startSingleTouch:function(a){this.touchState="pan";this.isHolding=!0;if(a=this.getEventCoordinates(a))this.touchStartPoint={x:a.x,y:a.y},this.mapStartPosition={x:this.map.left,y:this.map.top},this.hasMoved=!1},_continueSingleTouch:function(a){if(this.isHolding&&this.touchStartPoint&&this.mapStartPosition){var b=this.getEventCoordinates(a);if(b){a=b.x-this.touchStartPoint.x;
b=b.y-this.touchStartPoint.y;if(!this.hasMoved)if(5<Math.abs(a)+Math.abs(b))this.hasMoved=!0,this._startDragging();else return;this.map.moveTo(this.mapStartPosition.x+a,this.mapStartPosition.y+b)}}},_startPinchZoom:function(a,b){this.touchState="zoom";this.isHolding=!1;this._stopDragging();a=this.getEventCoordinates(a);b=this.getEventCoordinates(b);a&&b&&(this.startDistance=this.getDistance(a.x,a.y,b.x,b.y),this.startScale=this.map.scale,this.zoomCenter={x:(a.x+b.x)/2,y:(a.y+b.y)/2})},_continuePinchZoom:function(a,
b){this.startDistance&&this.startScale&&this.zoomCenter&&(a=this.getEventCoordinates(a),b=this.getEventCoordinates(b),a&&b&&(b=this.getDistance(a.x,a.y,b.x,b.y),b=b/this.startDistance*this.startScale,b=Math.max(Config.WorldMap.minScale,Math.min(Config.WorldMap.maxScale,b)),this.map.zoomTo(b,{x:this.zoomCenter.x-this.map.left,y:this.zoomCenter.y-this.map.top})))},_endTouch:function(){this.touchState=null;this.isHolding=!1;this.mapStartPosition=this.touchStartPoint=this.zoomCenter=this.startScale=this.startDistance=
null;this.hasMoved=!1;this._stopDragging()},emergencyReset:function(){console.warn("Emergency reset triggered");this.stopAnimation();this.isHolding=this.inMotion=!1;this.startDistance=null;this.arrowKeyStatus=0;this._stopDragging();this.mapStartPosition=this.touchStartPoint=this.touchState=null;this.hasMoved=!1;this.startScale=this.startDistance=this.zoomCenter=null;this.keyboardTimer&&(clearTimeout(this.keyboardTimer),this.keyboardTimer=null);this.mousePoint.x=-1;this.mousePoint.y=-1},handleKey:function(a){var b=
...
8}0<this.arrowKeyStatus&&null==this.keyboardTimer&&d();break;case "keyup":switch(c){case 37:case 65:b.arrowKeyStatus&=-2;break;case 38:case 87:b.arrowKeyStatus&=-3;break;case 39:case 68:b.arrowKeyStatus&=-5;break;case 40:case 83:b.arrowKeyStatus&=-9}0==b.arrowKeyStatus&&null!=b.keyboardTimer&&(clearTimeout(b.keyboardTimer),b.keyboardTimer=null)}},getEventCoordinates:function(a){var b=a.clientX;a=a.clientY;if(void 0===b||void 0===a)return null;var c=this.frameObj.getBoundingClientRect();return{x:b-
c.left,y:a-c.top}},getEventPositionOnMap:function(a){return(a=this.getEventCoordinates(a))?{x:a.x-this.map.left,y:a.y-this.map.top}:null},getDistance:function(a,b,c,d){return Math.sqrt((c-a)*(c-a)+(d-b)*(d-b))},_startDragging:function(){document.body.classList.add("dragging")},_stopDragging:function(){document.body.classList.remove("dragging")},convertFramePointToMap:function(a,b){return{x:a-this.frameObj.offsetLeft-this.map.left,y:b-this.frameObj.offsetTop-this.map.top}},home:function(){var a=this.map.getPoiPosition("SHA");
this.startAnimation(a.x,a.y,Config.WorldMap.maxScale)},addCustomButton:function(a,b,c,d){this.toolbar&&this.toolbar.renderCustomButton(a,b,c,d)}};function WorldMap(){this.parent=this.frame=null;this.width=1E3;this.height=400;this.scale=1;this.top=this.left=0;this.onPositionChanged=this.onScaleChanged=this.extraGroup=this.mapGroup=this.svg=null}WorldMap.GHOST_POIS={POSITIVE_X:"ORD LAX SFO YVR YYZ JFK".split(" "),NEGATIVE_X:["SHA","NRT","ICN"]};
WorldMap.prototype={renderInto:function(a,b){this.parent=a;this.svg=this.parent.createChildNS("svg",{id:"svg",width:this.width,height:this.height});this.mapGroup=this.svg.createChildNS("g");this.extraGroup=this.svg.createChildNS("g");this.renderCountries(this.mapGroup);"function"==typeof b&&b()},resize:function(a,b){this.svg.style.width=a+"px";this.svg.style.height=b+"px";this.svg.attr("width",a);this.svg.attr("height",b)},getExtraGroup:function(){return this.extraGroup},_clearElementCache:function(){this._poiElements=
this._routePaths=this._flightPaths=this._cachedElements=null},updateTransform:function(){this.mapGroup.attr({transform:Util.format_str("translate({left}, {top}) scale({scale}, {scale})",{left:this.left,top:this.top,scale:this.scale})});this._cachedElements||(this._cachedElements={countries:this.mapGroup.querySelectorAll("path.country"),border:this.mapGroup.querySelector("path.border"),routes:this.mapGroup.querySelectorAll("path.route, path.flight")});for(var a=1/this.scale,b=this._cachedElements.countries,
c=0;c<b.length;c++)b[c].attr("stroke-width",a);if(c=this._cachedElements.border)c.attr("stroke-width",a),c.attr("stroke-dasharray",Util.format_str("{size},{size}",{size:5/this.scale}));c=this._shouldHidePoisForYearFilter();this._updatePoiLabels(c);this._updatePoiCircles(c);b=this.mapGroup.querySelectorAll("path.route, path.flight");var d="{0},{0}".format(2/this.scale);for(c=0;c<b.length;c++)b[c].attr("stroke-width",a),null!=b[c].attr("stroke-dasharray")&&b[c].attr("stroke-dasharray",d);this._cachedElements&&
(this._cachedElements.routes=b)},renderCountries:function(a){for(var b in worldmap.shapes)a.createChildNS("path",{d:worldmap.shapes[b],stroke:"#333333",fill:"#f0efeb","stroke-opacity":.6,"stroke-width":1,class:"country"});this.renderGhostCountry(this.mapGroup,"US",this.width);this.renderGhostCountry(this.mapGroup,"CA",this.width);this.renderGhostCountry(this.mapGroup,"CN",-this.width);this.renderGhostCountry(this.mapGroup,"TW",-this.width);this.renderGhostCountry(this.mapGroup,"KR",-this.width);this.renderGhostCountry(this.mapGroup,
"JP",-this.width);a.createChildNS("path",{d:Util.format_str("M0,0 H{width} V{height} H0 Z",{width:this.width,height:this.height}),stroke:"#000000",fill:"none","stroke-width":1,"stroke-opacity":.2,"stroke-dasharray":"5,5",class:"border"})},renderGhostCountry:function(a,b,c){var d=this;a=a.createChildNS("path",{d:worldmap.shapes[b],stroke:"RGBA(127,127,127, 0.4)",fill:"RGBA(255,255,255,0.1)","stroke-opacity":.6,"stroke-width":1,class:"country",transform:Util.format_str("translate({left},0)",{left:c})});
var e=function(){d.frame.moveMapTo(d.left+c*d.scale,d.top,null)};a.addEventListener("mousedown",function(){e()},!1);a.addEventListener("touchstart",function(){e()},!1)},renderPois:function(a){var b=this;window.mapdata.pois.forEach(function(c){b.renderPoi(a,c,0);b._renderGhostPois(a,c)})},renderPoi:function(a,b,c){var d=b.label,e=b.level,f=b.key,g=this.parseLatLon(b.latlon);b=g.x;g=g.y;null!=c&&0!=c&&(b+=c);a.createChildNS("circle",{cx:b,cy:g,r:0,fill:"#E66C0F",stroke:"none",class:"poi-circle","data-poi-key":f});
a.createChildNS("text",{x:b,y:g,fill:"#000000",stroke:"none","font-size":1/this.scale*12,class:"poi-label",style:"display: none","data-level":e,"data-poi-key":f},d)},getControlPoint:function(a,b,c,d){var e=(a.x+b.x)/2;b=(a.y+b.y)/2;var f=Math.sqrt(Math.pow(a.x-e,2)+Math.pow(a.y-b,2));c*=f;var g={x:(a.y-b)*c/f+e,y:(e-a.x)*c/f+b};a={x:(b-a.y)*c/f+e,y:(a.x-e)*c/f+b};return 0<Math.atan2(g.y-b,g.x-e)*d?g:a},drawFlightLine:function(a,b,c,d){0==d?(this.drawFlightLine(a,b,c,-1),this.drawFlightLine(a,b,c,
1)):(d=this.getControlPoint(b,c,.6,d),a.createChildNS("path",{d:Util.format_str("M{from.x},{from.y} Q{control.x},{control.y} {to.x},{to.y}",{from:{x:b.x,y:b.y},control:{x:d.x,y:d.y},to:{x:c.x,y:c.y}}),fill:"none",stroke:Config.colors[Config.colorIndex%Config.colors.length],"stroke-width":1,class:"flight"}))},renderFlight:function(a,b,c,d,e){b=this.getPoiPosition(b);c=this.getPoiPosition(c);d?(d={x:b.x>c.x?b.x-this.width:this.width+b.x,y:b.y},this.drawFlightLine(a,b,{x:b.x>c.x?this.width+c.x:c.x-this.width,
y:c.y},e),this.drawFlightLine(a,d,c,e)):this.drawFlightLine(a,b,c,e)},renderRouteGroup:function(a,b){var c=this,d="";b.forEach(function(e){e=0<e.indexOf(",")?c.parseLatLon(e):c.getPoiPosition(e);d=0<d.length?d+" L{0},{1}".format(e.x,e.y):d+"M{0},{1}".format(e.x,e.y)});a.createChildNS("path",{d:d,fill:"none",stroke:"#ff0000","stroke-width":1,"stroke-dasharray":"2,2",class:"route"})},renderFlightsAndRoutes:function(a){var b=this;window.mapdata.flights.forEach(function(c){c.forEach(function(d){b.renderFlight(a,
d.from,d.to,d.crossPacific,d.direction)});Config.colorIndex++});window.mapdata.routes.forEach(function(c){b.renderRouteGroup(a,c.path)})},zoom:function(a,b){if(this.scale<Config.WorldMap.minScale&&1>a||this.scale>Config.WorldMap.maxScale&&1<a)return!1;var c=b.x*(1-a);b=b.y*(1-a);this.scale*=a;this.move(c,b)||this.updateTransform();if("function"==typeof this.onScaleChanged)this.onScaleChanged();return!0},zoomTo:function(a,b){return this.zoom(a/this.scale,b)},move:function(a,b){if(0==a&&0==b)return!1;
this.moveTo(this.left+a,this.top+b,null);return!0},moveTo:function(a,b){this.left=a;this.top=b;this.updateTransform();if("function"==typeof this.onPositionChanged)this.onPositionChanged()},showFlights:function(a){this._flightPaths||(this._flightPaths=this.mapGroup.querySelectorAll("path.flight"));var b=this._flightPaths;requestAnimationFrame(function(){for(var c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")})},filterByYears:function(a){this.filterByYearsAndProfiles(a,["h"])},filterByYearsAndProfiles:function(a,
b){if(a&&0!==a.length){b&&0!==b.length||(b=["h"]);this._clearAllElements();this._clearElementCache();var c=this._filterFlightsByYearsAndProfiles(a,b);this._renderFilteredFlights(c);this._renderFilteredRoutes(a,b);this._renderFilteredPoisWithProfiles(a,b);this.updateTransform()}else this._clearAllElements(),this._clearElementCache(),this._flightPaths=null},_filterFlightsByYears:function(a){return this._filterFlightsByYearsAndProfiles(a,["h"])},_filterFlightsByYearsAndProfiles:function(a,b){var c=[],
d=this;window.mapdata.flights.forEach(function(e){var f=[];e.forEach(function(g){var l=g.year&&-1!==a.indexOf(g.year),n=d._matchesProfile(g.profile,b);l&&n&&f.push(g)});0<f.length&&c.push(f)});return c},_renderFilteredPois:function(a){this._renderFilteredPoisWithProfiles(a,["h"])},_renderFilteredPoisWithProfiles:function(a,b){var c=this;window.mapdata.pois.forEach(function(d){var e=c._shouldShowPoiForYears(d,a),f=c._matchesProfile(d.profile,b);e&&f&&(c.renderPoi(c.mapGroup,d,0),c._renderGhostPois(c.mapGroup,
d))})},_shouldShowPoiForYears:function(a,b){if(!a.year)return!1;a=this._parseYears(a.year);for(var c=0;c<a.length;c++)if(-1!==b.indexOf(a[c]))return!0;return!1},_parseYears:function(a){return"string"===typeof a?-1<a.indexOf(",")?a.split(",").map(function(b){return parseInt(b.trim())}):[parseInt(a)]:[a]},showRoutes:function(a){this._routePaths||(this._routePaths=this.mapGroup.querySelectorAll("path.route"));var b=this._routePaths;requestAnimationFrame(function(){for(var c=0;c<b.length;c++)b[c].updateStyle("display",
a?null:"none")})},showPois:function(a){this._poiElements||(this._poiElements=this.mapGroup.querySelectorAll("circle.poi-circle, text.poi-label"));var b=this._poiElements;requestAnimationFrame(function(){for(var c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")})},restoreOriginalRendering:function(){this._clearAllElements();Config.colorIndex=0;this.renderFlightsAndRoutes(this.mapGroup);this.renderPois(this.mapGroup);this._applyCurrentToggleStates();this.updateTransform()},getPoi:function(a){for(var b=
...
"font-family":"Arial, sans-serif",style:"cursor: pointer"},e);return{bg:l,checkmark:f,text:a,touchArea:g}},_addCheckboxEventHandlers:function(a,b,c,d){var e=0,f=a.attr("fill"),g=null,l=!1,n=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;g={x:h.clientX,y:h.clientY};l=!1;a.attr("fill","#e6f3ff")},q=function(h){g&&5<Math.abs(h.clientX-g.x)+Math.abs(h.clientY-g.y)&&(l=!0,a.attr("fill",f))},r=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;g&&!l&&d();g=null;l=!1;a.attr("fill",
f)},p=function(h){!g&&300<Date.now()-e&&a.attr("fill","#f0f0f0")},m=function(h){g?(g=null,l=!1,a.attr("fill",f)):300<Date.now()-e&&a.attr("fill",f)},k=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();a.attr("fill","#e6f3ff")},t=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();a.attr("fill",f);d()},u=function(h){h.preventDefault();h.stopPropagation();h._handled=!0;e=Date.now();a.attr("fill",f)},v=function(h){h.preventDefault();h.stopPropagation();
h._handled=!0};[a,b,c].forEach(function(h){h.addEventListener("mousedown",n);h.addEventListener("mousemove",q);h.addEventListener("mouseup",r);h.addEventListener("mouseenter",p);h.addEventListener("mouseleave",m);h.addEventListener("touchstart",k,{passive:!1});h.addEventListener("touchend",t,{passive:!1});h.addEventListener("touchcancel",u,{passive:!1});h.addEventListener("touchmove",v,{passive:!1})})},updateSVGCheckboxes:function(){if(this.yearFilter)for(var a=this.getUniqueFlightYears(),b=this.yearFilter.querySelectorAll("g.svg-checkbox"),
c=0;c<b.length;c++){var d=b[c],e=d.getAttribute("data-label");e="All Years"===e?this.selectedYears.length===a.length:-1!==this.selectedYears.indexOf(parseInt(e));d.isChecked=e;d.checkmarkElement&&(d.checkmarkElement.style.display=e?"block":"none")}},updateYearCheckboxes:function(){this.updateSVGCheckboxes()},updateAllCheckbox:function(){this.updateSVGCheckboxes()},applyYearFilter:function(){this.frame.map.filterByYears(this.selectedYears);var a=this.getUniqueFlightYears();a=0===this.selectedYears.length?
"none":this.selectedYears.length===a.length?"":this.selectedYears.join(",");Util.setUrlHash("years",a);this.applyProfileFilter()},adjustPosition:function(a,b){this.scaleGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:a-Config.Toolbar.marginRight-Config.Toolbar.buttonSize,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}));this.toolGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:Config.Toolbar.marginLeft,top:Config.Toolbar.marginTop}));
this.naviGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:Config.Toolbar.marginLeft,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}));this.positionYearFilter(a,b)},renderButton:function(a,b,c,d,e,f,g,l,n){var q=this,r=0;a=a.createChildNS("g",{transform:"translate({0}, {1})".format((Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)*c,(Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)*b)});var p=a.createChildNS("path",
{fill:f?"RGBA(0,0,0,1)":"none",stroke:e?"RGBA(0,0,0,1)":"none","stroke-width":4,"stroke-linejoin":"round",d:d,transform:"translate({0}, {0})".format(Config.Toolbar.buttonPadding)}),m=a.createChildNS("rect",{fill:"RGBA(255,255,255,0.4)",stroke:g?"#333":"none","stroke-width":1,x:0,y:0,rx:Config.Toolbar.buttonSize/8,ry:Config.Toolbar.buttonSize/8,width:Config.Toolbar.buttonSize,height:Config.Toolbar.buttonSize});m.addEventListener("touchstart",function(k){k.preventDefault();k.stopPropagation();k._handled=
!0;r=Date.now();q.highlightIcon(this.parentNode.childNodes[0],!0);"function"===typeof l&&l(k,p,m)},!0);m.addEventListener("touchend",function(k){k.preventDefault();k.stopPropagation();k._handled=!0;r=Date.now();q.highlightIcon(this.parentNode.childNodes[0],!1);"function"===typeof n&&n(k,p,m)},!0);m.addEventListener("touchcancel",function(k){k.preventDefault();k.stopPropagation();k._handled=!0;r=Date.now();q.highlightIcon(this.parentNode.childNodes[0],!1);"function"===typeof n&&n(k,p,m)},!0);m.addEventListener("touchmove",
function(k){k.preventDefault();k.stopPropagation();k._handled=!0},!0);m.addEventListener("mousedown",function(k){500>Date.now()-r||(q.highlightIcon(this.parentNode.childNodes[0],!0),"function"===typeof l&&l(k,p,m),k.stopPropagation())},!0);m.addEventListener("mouseup",function(k){500>Date.now()-r||(q.highlightIcon(this.parentNode.childNodes[0],!1),"function"===typeof n&&n(k,p,m),k.stopPropagation())},!0);m.addEventListener("mouseout",function(k){500>Date.now()-r||(q.highlightIcon(this.parentNode.childNodes[0],
!1),"function"===typeof n&&n(k,p,m),k.stopPropagation())},!0);m.addEventListener("mousemove",function(k){k.stopPropagation()},!0);return{icon:p,overlay:m}},startZoomTimer:function(){var a=this;this.zoomTimer&&(clearTimeout(this.zoomTimer),this.zoomTimer=null);var b=function(){1!==a.zoomRatio&&"function"===typeof a.onZoom?(requestAnimationFrame(function(){a.onZoom(a.zoomRatio)}),a.zoomTimer=setTimeout(b,Config.Toolbar.zoomTimerDelay)):a.zoomTimer=null};b()},startNaviTimer:function(){var a=this;this.naviTimer&&
(clearTimeout(this.naviTimer),this.naviTimer=null);var b=function(){0===a.naviSpeed.x&&0===a.naviSpeed.y||"function"!==typeof a.onNavigate?a.naviTimer=null:(requestAnimationFrame(function(){a.onNavigate(a.naviSpeed.x,a.naviSpeed.y)}),a.naviTimer=setTimeout(b,Config.Toolbar.navTimerDelay))};b()},highlightIcon:function(a,b){"none"!=a.attr("stroke")&&a.attr("stroke",b?"#ff0000":"#000000");"none"!=a.attr("fill")&&a.attr("fill",b?"#ff0000":"#000000")}};
