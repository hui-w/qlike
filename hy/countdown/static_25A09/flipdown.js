...
class FlipDown {
  ...
  _init() {
    ...
    this.daysremaining = Math.floor(
      Math.abs(this.epoch - this.now) / 86400
    ).toString().length;
  ...
  _tick() {
    ...
    var diff = Math.abs(this.epoch - this.now);
    ...
    // If the countdown ended, fire the ifEnded callback once if it was set
    if (this.epoch - this.now < 0 && this.hasEndedCallback != null) {
