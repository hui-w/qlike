(function(){var Player={extend:function(obj){for(var key in obj){if(!obj.hasOwnProperty(key))continue;this[key]=obj[key]}},localStorageKey:"QSTAGE_VF710",localStorageSubKey:"player-cache",group:null,canvas:null,shapes:null,fps:20,projectId:null};Player.extend({play:function(stageObj){var that=this;var rootElement=document.body;var wrapper=document.createElement("div");rootElement.appendChild(wrapper);if(stageObj==null){var loading=document.createElement("div");loading.setAttribute("style","font-size: 16px; color: #ff3300; ");
